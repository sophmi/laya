...
extern "C" {
    ...
    #[no_mangle]
    fn opj_thread_pool_submit_job(tp: *mut opj_thread_pool_t,
                                  job_fn: opj_job_fn,
                                  user_data: *mut libc::c_void) -> OPJ_BOOL;
    #[no_mangle]
    fn opj_thread_pool_wait_completion(tp: *mut opj_thread_pool_t,
                                       max_remaining_jobs: libc::c_int);
    #[no_mangle]
    fn opj_thread_pool_get_thread_count(tp: *mut opj_thread_pool_t)
     -> libc::c_int;
    #[no_mangle]
    fn opj_sparse_array_int32_create(width: OPJ_UINT32, height: OPJ_UINT32,
                                     block_width: OPJ_UINT32,
                                     block_height: OPJ_UINT32)
     -> *mut opj_sparse_array_int32_t;
    #[no_mangle]
    fn opj_sparse_array_int32_write(sa: *mut opj_sparse_array_int32_t,
                                    x0: OPJ_UINT32, y0: OPJ_UINT32,
                                    x1: OPJ_UINT32, y1: OPJ_UINT32,
                                    src: *const OPJ_INT32,
                                    src_col_stride: OPJ_UINT32,
                                    src_line_stride: OPJ_UINT32,
                                    forgiving: OPJ_BOOL) -> OPJ_BOOL;
    #[no_mangle]
    fn opj_sparse_array_int32_read(sa: *const opj_sparse_array_int32_t,
                                   x0: OPJ_UINT32, y0: OPJ_UINT32,
                                   x1: OPJ_UINT32, y1: OPJ_UINT32,
                                   dest: *mut OPJ_INT32,
...
pub type opj_job_fn
    =
    Option<unsafe extern "C" fn(_: *mut libc::c_void, _: *mut opj_tls_t)
               -> ()>;
...
pub type opj_encode_and_deinterleave_h_one_row_fnptr_type
    =
    Option<unsafe extern "C" fn(_: *mut libc::c_void, _: *mut libc::c_void,
                                _: OPJ_UINT32, _: OPJ_BOOL) -> ()>;
/* Forward transform, for the vertical pass, processing cols columns */
/* where cols <= NB_ELTS_V8 */
/* Where void* is a OPJ_INT32* for 5x3 and OPJ_FLOAT32* for 9x7 */
pub type opj_encode_and_deinterleave_v_fnptr_type
    =
    Option<unsafe extern "C" fn(_: *mut libc::c_void, _: *mut libc::c_void,
                                _: OPJ_UINT32, _: OPJ_BOOL, _: OPJ_UINT32,
                                _: OPJ_UINT32) -> ()>;
#[derive(Copy, Clone)]
#[repr(C)]
...
#[inline]
unsafe extern "C" fn opj_uint_ceildivpow2(mut a: OPJ_UINT32,
                                          mut b: OPJ_UINT32) -> OPJ_UINT32 {
    return ((a as
                 libc::c_ulong).wrapping_add((1 as libc::c_uint as OPJ_UINT64)
                                                 <<
                                                 b).wrapping_sub(1 as
                                                                     libc::c_uint
                                                                     as
...
#[inline]
unsafe extern "C" fn opj_uint_subs(mut a: OPJ_UINT32, mut b: OPJ_UINT32)
 -> OPJ_UINT32 {
    return if a >= b {
               a.wrapping_sub(b)
...
#[inline]
unsafe extern "C" fn opj_uint_adds(mut a: OPJ_UINT32, mut b: OPJ_UINT32)
 -> OPJ_UINT32 {
    let mut sum = (a as OPJ_UINT64).wrapping_add(b as OPJ_UINT64);
    return -((sum >> 32 as libc::c_int) as OPJ_INT32) as OPJ_UINT32 |
               sum as OPJ_UINT32;
}
#[inline]
...
#[inline]
unsafe extern "C" fn opj_int_sub_no_overflow(mut a: OPJ_INT32,
                                             mut b: OPJ_INT32) -> OPJ_INT32 {
...
#[inline]
unsafe extern "C" fn opj_int_add_no_overflow(mut a: OPJ_INT32,
                                             mut b: OPJ_INT32) -> OPJ_INT32 {
    let mut pa = &mut a as *mut OPJ_INT32 as *mut libc::c_void;
    let mut pb = &mut b as *mut OPJ_INT32 as *mut libc::c_void;
    let mut upa = pa as *mut OPJ_UINT32;
...
static mut opj_dwt_norms: [[OPJ_FLOAT64; 10]; 4] =
    [[1.000f64, 1.500f64, 2.750f64, 5.375f64, 10.68f64, 21.34f64, 42.67f64,
      85.33f64, 170.7f64, 341.3f64],
     [1.038f64, 1.592f64, 2.919f64, 5.703f64, 11.33f64, 22.64f64, 45.25f64,
      90.48f64, 180.9f64, 0.],
     [1.038f64, 1.592f64, 2.919f64, 5.703f64, 11.33f64, 22.64f64, 45.25f64,
      90.48f64, 180.9f64, 0.],
     [0.7186f64, 0.9218f64, 1.586f64, 3.043f64, 6.019f64, 12.01f64, 24.00f64,
      47.97f64, 95.93f64, 0.]];
/* <summary>                                                              */
...
static mut opj_dwt_norms_real: [[OPJ_FLOAT64; 10]; 4] =
    [[1.000f64, 1.965f64, 4.177f64, 8.403f64, 16.90f64, 33.84f64, 67.69f64,
      135.3f64, 270.6f64, 540.9f64],
     [2.022f64, 3.989f64, 8.355f64, 17.04f64, 34.27f64, 68.63f64, 137.3f64,
      274.6f64, 549.0f64, 0.],
     [2.022f64, 3.989f64, 8.355f64, 17.04f64, 34.27f64, 68.63f64, 137.3f64,
      274.6f64, 549.0f64, 0.],
     [2.080f64, 3.865f64, 8.307f64, 17.18f64, 34.71f64, 69.59f64, 139.3f64,
      278.6f64, 557.2f64, 0.]];
/*@}*/
...
/* Forward lazy transform (horizontal).  */
/* </summary>                            */
unsafe extern "C" fn opj_dwt_deinterleave_h(mut a: *const OPJ_INT32,
                                            mut b: *mut OPJ_INT32,
                                            mut dn: OPJ_INT32,
                                            mut sn: OPJ_INT32,
                                            mut cas: OPJ_INT32) {
...
/* </summary>                            */
unsafe extern "C" fn opj_dwt_interleave_h(mut h: *const opj_dwt_t,
                                          mut a: *mut OPJ_INT32) {
    ...
    bi =
        (*h).mem.offset(1 as libc::c_int as
                            isize).offset(-((*h).cas as isize));
    i = (*h).dn;
    loop  {
        let fresh4 = i;
        i = i - 1;
...
/* </summary>                            */
unsafe extern "C" fn opj_dwt_interleave_v(mut v: *const opj_dwt_t,
                                          mut a: *mut OPJ_INT32,
                                          mut x: OPJ_INT32) {
    let mut ai: *const OPJ_INT32 = a;
    ...
    ai =
        a.offset(((*v).sn as libc::c_ulong).wrapping_mul(x as OPJ_SIZE_T) as
                     isize);
    bi =
        (*v).mem.offset(1 as libc::c_int as
                            isize).offset(-((*v).cas as isize));
    i = (*v).dn;
    loop  {
        let fresh7 = i;
        i = i - 1;
...
/* </summary>                           */
unsafe extern "C" fn opj_dwt_decode_1_(mut a: *mut OPJ_INT32,
                                       mut dn: OPJ_INT32, mut sn: OPJ_INT32,
                                       mut cas: OPJ_INT32) {
    let mut i: OPJ_INT32 = 0;
    if cas == 0 {
        if dn > 0 as libc::c_int || sn > 1 as libc::c_int {
            ...
            while i < dn {
                let ref mut fresh9 =
                    *a.offset((1 as libc::c_int + i * 2 as libc::c_int) as
                                  isize);
                *fresh9 +=
                    (if i < 0 as libc::c_int {
                         *a.offset((0 as libc::c_int * 2 as libc::c_int) as
                                       isize)
                     } else {
                         (if i >= sn {
                              *a.offset(((sn - 1 as libc::c_int) *
                                             2 as libc::c_int) as isize)
                          } else {
                              *a.offset((i * 2 as libc::c_int) as isize)
                          })
                        ...
                        (if (i + 1 as libc::c_int) < 0 as libc::c_int {
                             *a.offset((0 as libc::c_int * 2 as libc::c_int)
                                           as isize)
                         } else {
            ...
            *fresh11 -=
                (if i < 0 as libc::c_int {
                     *a.offset((0 as libc::c_int * 2 as libc::c_int) as isize)
                     ...
                     (if i >= dn {
                          *a.offset(((dn - 1 as libc::c_int) *
                                         2 as libc::c_int) as isize)
                      } else { *a.offset((i * 2 as libc::c_int) as isize) })
                 }) +
                    (if (i + 1 as libc::c_int) < 0 as libc::c_int {
                         *a.offset((0 as libc::c_int * 2 as libc::c_int) as
                                       isize)
                ...
                (if i < 0 as libc::c_int {
                     *a.offset((1 as libc::c_int +
                     ...
                     (if i >= sn {
                          ...
                          *a.offset((1 as libc::c_int + i * 2 as libc::c_int)
                                        as isize)
                      })
                 }) +
                    (if (i - 1 as libc::c_int) < 0 as libc::c_int {
...
unsafe extern "C" fn opj_idwt53_h(mut dwt: *const opj_dwt_t,
                                  mut tiledp: *mut OPJ_INT32) {
    /* For documentation purpose */
    opj_dwt_interleave_h(dwt, tiledp);
    opj_dwt_decode_1(dwt);
    memcpy(tiledp as *mut libc::c_void, (*dwt).mem as *const libc::c_void,
           (((*dwt).sn + (*dwt).dn) as OPJ_UINT32 as
...
/* </summary>                           */
/* Performs interleave, inverse wavelet transform and copy back to buffer */
unsafe extern "C" fn opj_idwt53_v(mut dwt: *const opj_dwt_t,
    ...
    c = 0 as libc::c_int;
    while c < nb_cols {
        opj_dwt_interleave_v(dwt, tiledp_col.offset(c as isize),
                             stride as OPJ_INT32);
        opj_dwt_decode_1(dwt);
        k = 0 as libc::c_int;
        while k < (*dwt).sn + (*dwt).dn {
            *tiledp_col.offset((c as
                                    libc::c_ulong).wrapping_add((k as
                                                                     libc::c_ulong).wrapping_mul(stride))
                                   as isize) = *(*dwt).mem.offset(k as isize);
            k += 1
        }
        c += 1
    };
}
unsafe extern "C" fn opj_dwt_encode_step1_combined(mut fw: *mut OPJ_FLOAT32,
    ...
    if fw as OPJ_SIZE_T & 0xf as libc::c_int as libc::c_ulong ==
           0 as libc::c_int as libc::c_ulong {
    } else {
        __assert_fail(b"(((OPJ_SIZE_T)fw) & 0xf) == 0\x00" as *const u8 as
                          *const libc::c_char,
                      b"/opt/openjpeg/src/lib/openjp2/dwt.c\x00" as *const u8
                          as *const libc::c_char,
                      978 as libc::c_int as libc::c_uint,
                      (*::std::mem::transmute::<&[u8; 112],
                                                &[libc::c_char; 112]>(b"void opj_dwt_encode_step1_combined(OPJ_FLOAT32 *, OPJ_UINT32, OPJ_UINT32, const OPJ_FLOAT32, const OPJ_FLOAT32)\x00")).as_ptr());
    }
    if opj_int_abs(iters_c1 as OPJ_INT32 - iters_c2 as OPJ_INT32) <=
           1 as libc::c_int {
    } else {
        __assert_fail(b"opj_int_abs((OPJ_INT32)iters_c1 - (OPJ_INT32)iters_c2) <= 1\x00"
...
unsafe extern "C" fn opj_dwt_encode_step2(mut fl: *mut OPJ_FLOAT32,
    ...
    if imax > 0 as libc::c_int as libc::c_uint {
        ...
        *fresh25 +=
            (*fl.offset(0 as libc::c_int as isize) +
                 *fw.offset(0 as libc::c_int as isize)) * c;
        fw = fw.offset(2 as libc::c_int as isize);
        ...
        while i.wrapping_add(3 as libc::c_int as libc::c_uint) < imax {
            ...
            *fresh27 +=
                (*fw.offset(0 as libc::c_int as isize) +
                     *fw.offset(2 as libc::c_int as isize)) * c;
            let ref mut fresh28 = *fw.offset(3 as libc::c_int as isize);
            *fresh28 +=
                (*fw.offset(2 as libc::c_int as isize) +
                     *fw.offset(4 as libc::c_int as isize)) * c;
            let ref mut fresh29 = *fw.offset(5 as libc::c_int as isize);
            *fresh29 +=
                (*fw.offset(4 as libc::c_int as isize) +
                     *fw.offset(6 as libc::c_int as isize)) * c;
            fw = fw.offset(8 as libc::c_int as isize);
            i =
                (i as
    ...
    if m < end {
        if m.wrapping_add(1 as libc::c_int as libc::c_uint) == end {
        } else {
            __assert_fail(b"m + 1 == end\x00" as *const u8 as
                              *const libc::c_char,
                          b"/opt/openjpeg/src/lib/openjp2/dwt.c\x00" as
                              *const u8 as *const libc::c_char,
                          1035 as libc::c_int as libc::c_uint,
                          (*::std::mem::transmute::<&[u8; 93],
                                                    &[libc::c_char; 93]>(b"void opj_dwt_encode_step2(OPJ_FLOAT32 *, OPJ_FLOAT32 *, OPJ_UINT32, OPJ_UINT32, OPJ_FLOAT32)\x00")).as_ptr());
        }
...
*/
unsafe extern "C" fn opj_dwt_encode_1_real(mut aIn: *mut libc::c_void,
                                           mut dn: OPJ_INT32,
                                           mut sn: OPJ_INT32,
                                           mut cas: OPJ_INT32) {
    ...
    if dn + sn > 1 as libc::c_int {
    } else {
        __assert_fail(b"dn + sn > 1\x00" as *const u8 as *const libc::c_char,
                      b"/opt/openjpeg/src/lib/openjp2/dwt.c\x00" as *const u8
                          as *const libc::c_char,
                      1045 as libc::c_int as libc::c_uint,
                      (*::std::mem::transmute::<&[u8; 68],
                                                &[libc::c_char; 68]>(b"void opj_dwt_encode_1_real(void *, OPJ_INT32, OPJ_INT32, OPJ_INT32)\x00")).as_ptr());
    }
    if cas == 0 as libc::c_int {
        a = 0 as libc::c_int;
        b = 1 as libc::c_int
    } else { a = 1 as libc::c_int; b = 0 as libc::c_int }
    opj_dwt_encode_step2(w.offset(a as isize),
                         w.offset(b as
                         ...
                         opj_dwt_alpha);
    opj_dwt_encode_step2(w.offset(b as isize),
                         w.offset(a as
                                      isize).offset(1 as libc::c_int as
                                                        isize),
                         sn as OPJ_UINT32,
                         opj_int_min(sn, dn - a) as OPJ_UINT32, opj_dwt_beta);
    opj_dwt_encode_step2(w.offset(a as isize),
                         w.offset(b as
                                      isize).offset(1 as libc::c_int as
                                                        isize),
    ...
    if a == 0 as libc::c_int {
        opj_dwt_encode_step1_combined(w, sn as OPJ_UINT32, dn as OPJ_UINT32,
                                      opj_invK, opj_K);
    } else {
        opj_dwt_encode_step1_combined(w, dn as OPJ_UINT32, sn as OPJ_UINT32,
                                      opj_K, opj_invK);
    };
}
/* *
...
*/
unsafe extern "C" fn opj_dwt_encode_stepsize(mut stepsize: OPJ_INT32,
    ...
    (*bandno_stepsize).mant =
        (if n < 0 as libc::c_int {
             (stepsize) >> -n
         } else { (stepsize) << n }) & 0x7ff as libc::c_int;
...
unsafe extern "C" fn opj_dwt_encode_and_deinterleave_h_one_row(mut rowIn:
                                                                   *mut libc::c_void,
                                                               mut tmpIn:
                                                                   *mut libc::c_void,
                                                               mut width:
    ...
    if even != 0 {
        if width > 1 as libc::c_int as libc::c_uint {
            ...
            while i < sn - 1 as libc::c_int {
                *tmp.offset((sn + i) as isize) =
                    *row.offset((2 as libc::c_int * i + 1 as libc::c_int) as
                                    isize) -
                        (*row.offset((i * 2 as libc::c_int) as isize) +
                             *row.offset(((i + 1 as libc::c_int) *
                                              2 as libc::c_int) as isize) >>
                             1 as libc::c_int);
                i += 1
            }
            if width.wrapping_rem(2 as libc::c_int as libc::c_uint) ==
            ...
            *fresh32 +=
                *tmp.offset(sn as isize) + *tmp.offset(sn as isize) +
                    2 as libc::c_int >> 2 as libc::c_int;
            i = 1 as libc::c_int;
            while i < dn {
                *row.offset(i as isize) =
                    *row.offset((2 as libc::c_int * i) as isize) +
                        (*tmp.offset((sn + (i - 1 as libc::c_int)) as isize) +
                             *tmp.offset((sn + i) as isize) + 2 as libc::c_int
                             >> 2 as libc::c_int);
                i += 1
            }
            if width.wrapping_rem(2 as libc::c_int as libc::c_uint) ==
                ...
                *row.offset(i as isize) =
                    *row.offset((2 as libc::c_int * i) as isize) +
                        (*tmp.offset((sn + (i - 1 as libc::c_int)) as isize) +
                             *tmp.offset((sn + (i - 1 as libc::c_int)) as
                                             isize) + 2 as libc::c_int >>
                             2 as libc::c_int)
            }
            memcpy(row.offset(sn as isize) as *mut libc::c_void,
                   tmp.offset(sn as isize) as *const libc::c_void,
                   (dn as
                        OPJ_SIZE_T).wrapping_mul(::std::mem::size_of::<OPJ_INT32>()
                                                     as libc::c_ulong));
        }
        ...
        *tmp.offset((sn + 0 as libc::c_int) as isize) =
            *row.offset(0 as libc::c_int as isize) -
                *row.offset(1 as libc::c_int as isize);
        i_0 = 1 as libc::c_int;
        while i_0 < sn {
            *tmp.offset((sn + i_0) as isize) =
                *row.offset((2 as libc::c_int * i_0) as isize) -
                    (*row.offset((2 as libc::c_int * i_0 + 1 as libc::c_int)
                                     as isize) +
                         *row.offset((2 as libc::c_int *
                                          (i_0 - 1 as libc::c_int) +
        ...
        while i_0 < dn - 1 as libc::c_int {
            *row.offset(i_0 as isize) =
                *row.offset((2 as libc::c_int * i_0 + 1 as libc::c_int) as
                                isize) +
                    (*tmp.offset((sn + i_0) as isize) +
        ...
        if width.wrapping_rem(2 as libc::c_int as libc::c_uint) ==
            ...
            *row.offset(i_0 as isize) =
                *row.offset((2 as libc::c_int * i_0 + 1 as libc::c_int) as
                                isize) +
                    (*tmp.offset((sn + i_0) as isize) +
                         *tmp.offset((sn + i_0) as isize) + 2 as libc::c_int
                         >> 2 as libc::c_int)
        }
        memcpy(row.offset(sn as isize) as *mut libc::c_void,
               tmp.offset(sn as isize) as *const libc::c_void,
...
unsafe extern "C" fn opj_dwt_encode_and_deinterleave_h_one_row_real(mut rowIn:
                                                                        *mut libc::c_void,
                                                                    mut tmpIn:
                                                                        *mut libc::c_void,
                                                                    mut width:
    ...
    let sn =
        (width.wrapping_add((if even != 0 {
             ...
             1 as libc::c_int) as OPJ_INT32;
    let dn = width.wrapping_sub(sn as OPJ_UINT32) as OPJ_INT32;
    if width == 1 as libc::c_int as libc::c_uint { return }
    memcpy(tmp as *mut libc::c_void, row as *const libc::c_void,
           (width as
                libc::c_ulong).wrapping_mul(::std::mem::size_of::<OPJ_FLOAT32>()
                                                as libc::c_ulong));
    opj_dwt_encode_1_real(tmp as *mut libc::c_void, dn, sn,
                          if even != 0 {
                              0 as libc::c_int
                          } else { 1 as libc::c_int });
    opj_dwt_deinterleave_h(tmp as *mut OPJ_INT32, row as *mut OPJ_INT32, dn,
                           sn,
                           if even != 0 {
                               0 as libc::c_int
                           } else { 1 as libc::c_int });
...
unsafe extern "C" fn opj_dwt_encode_h_func(mut user_data: *mut libc::c_void,
    ...
    while j < (*job).max_j {
        ...
        Some((*job).p_function.expect("non-null function pointer")).expect("non-null function pointer")(aj
                                                                                                            as
                                                                                                            *mut libc::c_void,
                                                                                                        (*job).h.mem
                                                                                                            as
...
unsafe extern "C" fn opj_dwt_encode_v_func(mut user_data: *mut libc::c_void,
    ...
    j = (*job).min_j;
    while j.wrapping_add(8 as libc::c_int as
                             libc::c_uint).wrapping_sub(1 as libc::c_int as
                                                            libc::c_uint) <
              (*job).max_j {
        Some((*job).p_encode_and_deinterleave_v.expect("non-null function pointer")).expect("non-null function pointer")((*job).tiledp.offset(j
                                                                                                                                                  as
                                                                                                                                                  isize)
                                                                                                                             as
                                                                                                                             *mut libc::c_void,
                                                                                                                         ...
                                                                                                                         8
                                                                                                                             ...
                                                                                                                             OPJ_UINT32);
        j =
            (j as libc::c_uint).wrapping_add(8 as libc::c_int as libc::c_uint)
                as OPJ_UINT32 as OPJ_UINT32
    }
    if j < (*job).max_j {
        Some((*job).p_encode_and_deinterleave_v.expect("non-null function pointer")).expect("non-null function pointer")((*job).tiledp.offset(j
...
unsafe extern "C" fn opj_dwt_fetch_cols_vertical_pass(mut arrayIn:
                                                          *const libc::c_void,
                                                      mut tmpOut:
                                                          *mut libc::c_void,
    ...
    if cols == 8 as libc::c_int as libc::c_uint {
        ...
        while k < height {
            memcpy(tmp.offset((8 as libc::c_int as
                                   libc::c_uint).wrapping_mul(k) as isize) as
                       *mut libc::c_void,
                   array.offset(k.wrapping_mul(stride_width) as isize) as
                       *const libc::c_void,
                   (8 as libc::c_int as
                        libc::c_ulong).wrapping_mul(::std::mem::size_of::<OPJ_INT32>()
                                                        as libc::c_ulong));
        ...
        while k_0 < height {
            ...
            while c < cols {
                *tmp.offset((8 as libc::c_int as
                                 libc::c_uint).wrapping_mul(k_0).wrapping_add(c)
                                as isize) =
                    *array.offset(c.wrapping_add(k_0.wrapping_mul(stride_width))
                                      as isize);
                c = c.wrapping_add(1)
            }
...
/* columns. */
#[inline]
unsafe extern "C" fn opj_dwt_deinterleave_v_cols(mut src: *const OPJ_INT32,
    ...
    let mut l_src =
        src.offset((cas * 8 as libc::c_int) as isize); /* fallthru */
    ...
    while k < 2 as libc::c_int {
        loop  {
            ...
            if !(fresh34 != 0) { break ; }
            if cols == 8 as libc::c_int as libc::c_uint {
                memcpy(l_dest as *mut libc::c_void,
                ...
                match cols {
                    7 => {
                        *l_dest.offset(c as isize) =
                            *l_src.offset(c as isize);
                        c = c.wrapping_add(1);
                        current_block_16 = 3516197883607697062;
                    }
                    6 => { current_block_16 = 3516197883607697062; }
                    5 => { current_block_16 = 3520964086993316036; }
                    4 => { current_block_16 = 5597948028301642222; }
                    3 => { current_block_16 = 6886095072222541387; }
                    2 => { current_block_16 = 12368470615728410476; }
                    _ => { current_block_16 = 8007710116773720393; }
                }
            ...
            l_src =
                l_src.offset((2 as libc::c_int * 8 as libc::c_int) as isize)
        }
        l_dest =
            dst.offset((sn as
                            OPJ_SIZE_T).wrapping_mul(stride_width as
                                                         OPJ_SIZE_T) as
                           isize);
        l_src =
            src.offset(((1 as libc::c_int - cas) * 8 as libc::c_int) as
                           isize);
        i = dn;
        k += 1
    };
...
/* where cols <= NB_ELTS_V8 */
unsafe extern "C" fn opj_dwt_encode_and_deinterleave_v(mut arrayIn:
                                                           *mut libc::c_void,
                                                       mut tmpIn:
                                                           *mut libc::c_void,
                                                       mut height: OPJ_UINT32,
    ...
    let mut tmp = tmpIn as *mut OPJ_INT32;
    let sn =
        height.wrapping_add((if even != 0 {
                                 1 as libc::c_int
                             } else { 0 as libc::c_int }) as libc::c_uint) >>
            1 as libc::c_int;
    let dn = height.wrapping_sub(sn);
    opj_dwt_fetch_cols_vertical_pass(arrayIn, tmpIn, height, stride_width,
                                     cols);
    if even != 0 {
        let mut c: OPJ_UINT32 = 0;
        if height > 1 as libc::c_int as libc::c_uint {
                ...
                while c < 8 as libc::c_int as libc::c_uint {
                    let ref mut fresh35 =
                        *tmp.offset((1 as libc::c_int as
                                        ...
                                        as isize);
                    *fresh35 -=
                        *tmp.offset(i.wrapping_mul(2 as libc::c_int as
                                                       libc::c_uint).wrapping_mul(8
                                                                                      as
                                                                                      libc::c_int
                                                                                      as
                                                                                      libc::c_uint).wrapping_add(c)
                                        as isize) +
                            *tmp.offset(i.wrapping_add(1 as libc::c_int as
            ...
            if height.wrapping_rem(2 as libc::c_int as libc::c_uint) ==
                   0 as libc::c_int as libc::c_uint {
                c = 0 as libc::c_int as OPJ_UINT32;
                while c < 8 as libc::c_int as libc::c_uint {
                    let ref mut fresh36 =
            ...
            while c < 8 as libc::c_int as libc::c_uint {
                let ref mut fresh37 =
                    *tmp.offset(((0 as libc::c_int * 2 as libc::c_int *
                                      8 as libc::c_int) as
                                     libc::c_uint).wrapping_add(c) as isize);
                *fresh37 +=
                    *tmp.offset((((1 as libc::c_int +
                                       0 as libc::c_int * 2 as libc::c_int) *
                                      8 as libc::c_int) as
                                     libc::c_uint).wrapping_add(c) as isize) +
                        *tmp.offset((((1 as libc::c_int +
            ...
            while i < dn {
                ...
                while c < 8 as libc::c_int as libc::c_uint {
                    ...
                    *fresh38 +=
                        *tmp.offset((1 as libc::c_int as
                                         libc::c_uint).wrapping_add(i.wrapping_sub(1
                                                                                       as
                                                                                       libc::c_int
                                                                                       as
                                                                                       libc::c_uint).wrapping_mul(2
        ...
        if height == 1 as libc::c_int as libc::c_uint {
            ...
            while c_0 < 8 as libc::c_int as libc::c_uint {
                let ref mut fresh40 =
                    *tmp.offset(((0 as libc::c_int * 2 as libc::c_int *
                                      8 as libc::c_int) as
                                     libc::c_uint).wrapping_add(c_0) as
                                    isize);
            ...
            while i_0 < sn {
                ...
                while c_0 < 8 as libc::c_int as libc::c_uint {
                    let ref mut fresh42 =
                        *tmp.offset(i_0.wrapping_mul(2 as libc::c_int as
                                                         libc::c_uint).wrapping_mul(8
                                                                                        as
                                                                                        libc::c_int
                                                                                        as
                                                                                        libc::c_uint).wrapping_add(c_0)
                                        as isize);
                    *fresh42 -=
                        *tmp.offset((1 as libc::c_int as
                                         libc::c_uint).wrapping_add(i_0.wrapping_mul(2
                                                                                         as
                                                                                         libc::c_int
                                                                                         as
                                                                                         libc::c_uint)).wrapping_mul(8
                                        ...
                                        as isize) +
                            *tmp.offset((1 as libc::c_int as
                                             libc::c_uint).wrapping_add(i_0.wrapping_sub(1
                                                                                             as
                                                                                             libc::c_int
                                                                                             as
                                                                                             libc::c_uint).wrapping_mul(2
                    ...
                    *fresh44 +=
                        *tmp.offset(i_0.wrapping_mul(2 as libc::c_int as
                                                         libc::c_uint).wrapping_mul(8
                                                                                        ...
                                                                                        libc::c_uint).wrapping_add(c_0)
                                        as isize) +
                            *tmp.offset(i_0.wrapping_add(1 as libc::c_int as
                                                             libc::c_uint).wrapping_mul(2
                                                                                            as
                                                                                            libc::c_int
                                                                                            as
    ...
    if cols == 8 as libc::c_int as libc::c_uint {
        opj_dwt_deinterleave_v_cols(tmp, array, dn as OPJ_INT32,
                                    sn as OPJ_INT32, stride_width,
                                    if even != 0 {
                                        0 as libc::c_int
                                    } else { 1 as libc::c_int },
        ...
        opj_dwt_deinterleave_v_cols(tmp, array, dn as OPJ_INT32,
                                    ...
                                    if even != 0 {
                                        0 as libc::c_int
                                    } else { 1 as libc::c_int }, cols);
    };
}
unsafe extern "C" fn opj_v8dwt_encode_step1(mut fw: *mut OPJ_FLOAT32,
                                            mut end: OPJ_UINT32,
                                            cst: OPJ_FLOAT32) {
    let mut i: OPJ_UINT32 = 0;
    let mut c: OPJ_UINT32 = 0;
    ...
    while i < end {
        ...
        while c < 8 as libc::c_int as libc::c_uint {
            let ref mut fresh46 =
                *fw.offset(i.wrapping_mul(2 as libc::c_int as
...
unsafe extern "C" fn opj_v8dwt_encode_step2(mut fl: *mut OPJ_FLOAT32,
                                            mut fw: *mut OPJ_FLOAT32,
                                            mut end: OPJ_UINT32,
                                            mut m: OPJ_UINT32,
                                            mut cst: OPJ_FLOAT32) {
    ...
    if imax > 0 as libc::c_int as libc::c_uint {
        ...
        while c < 8 as libc::c_int {
            let ref mut fresh47 =
                *fw.offset((-(1 as libc::c_int) * 8 as libc::c_int + c) as
                               isize);
            *fresh47 +=
                (*fl.offset((0 as libc::c_int * 8 as libc::c_int + c) as
                                isize) +
                     *fw.offset((0 as libc::c_int * 8 as libc::c_int + c) as
                                    isize)) * cst;
            c += 1
        }
            ...
            while c < 8 as libc::c_int {
                let ref mut fresh48 =
                    *fw.offset((-(1 as libc::c_int) * 8 as libc::c_int + c) as
                                   isize);
                *fresh48 +=
                    (*fw.offset((-(2 as libc::c_int) * 8 as libc::c_int + c)
                                    as isize) +
                         *fw.offset((0 as libc::c_int * 8 as libc::c_int + c)
                                        as isize)) * cst;
                c += 1
            }
            fw = fw.offset((2 as libc::c_int * 8 as libc::c_int) as isize);
    ...
    if m < end {
        if m.wrapping_add(1 as libc::c_int as libc::c_uint) == end {
            ...
            __assert_fail(b"m + 1 == end\x00" as *const u8 as
                          ...
                          b"/opt/openjpeg/src/lib/openjp2/dwt.c\x00" as
                              *const u8 as *const libc::c_char,
                          1639 as libc::c_int as libc::c_uint,
                          (*::std::mem::transmute::<&[u8; 95],
                                                    &[libc::c_char; 95]>(b"void opj_v8dwt_encode_step2(OPJ_FLOAT32 *, OPJ_FLOAT32 *, OPJ_UINT32, OPJ_UINT32, OPJ_FLOAT32)\x00")).as_ptr());
        }
        c = 0 as libc::c_int;
        while c < 8 as libc::c_int {
            let ref mut fresh49 =
            ...
            *fresh49 +=
                2 as libc::c_int as libc::c_float *
                    *fw.offset((-(2 as libc::c_int) * 8 as libc::c_int + c) as
                                   isize) * cst;
            c += 1
        }
    };
...
/* where cols <= NB_ELTS_V8 */
unsafe extern "C" fn opj_dwt_encode_and_deinterleave_v_real(mut arrayIn:
                                                                *mut libc::c_void,
                                                            mut tmpIn:
                                                                *mut libc::c_void,
                                                            mut height:
    ...
    let mut a: OPJ_INT32 = 0;
    let mut b: OPJ_INT32 = 0;
    if height == 1 as libc::c_int as libc::c_uint { return }
    opj_dwt_fetch_cols_vertical_pass(arrayIn, tmpIn, height, stride_width,
                                     cols);
    if even != 0 {
        a = 0 as libc::c_int;
    ...
    opj_v8dwt_encode_step2(tmp.offset((a * 8 as libc::c_int) as isize),
                           tmp.offset(((b + 1 as libc::c_int) *
                                           8 as libc::c_int) as isize),
                           dn as OPJ_UINT32,
                           opj_int_min(dn, sn - b) as OPJ_UINT32,
                           opj_dwt_alpha);
    opj_v8dwt_encode_step2(tmp.offset((b * 8 as libc::c_int) as isize),
                           tmp.offset(((a + 1 as libc::c_int) *
                                           8 as libc::c_int) as isize),
                           sn as OPJ_UINT32,
                           opj_int_min(sn, dn - a) as OPJ_UINT32,
                           opj_dwt_beta);
    ...
    opj_v8dwt_encode_step2(tmp.offset((b * 8 as libc::c_int) as isize),
                           ...
                           opj_int_min(sn, dn - a) as OPJ_UINT32,
                           opj_dwt_delta);
    opj_v8dwt_encode_step1(tmp.offset((b * 8 as libc::c_int) as isize),
                           dn as OPJ_UINT32, opj_K);
    opj_v8dwt_encode_step1(tmp.offset((a * 8 as libc::c_int) as isize),
                           sn as OPJ_UINT32, opj_invK);
    if cols == 8 as libc::c_int as libc::c_uint {
        opj_dwt_deinterleave_v_cols(tmp as *mut OPJ_INT32,
                                    array as *mut OPJ_INT32, dn, sn,
                                    stride_width,
                                    if even != 0 {
                                        0 as libc::c_int
                                    } else { 1 as libc::c_int },
...
/* </summary>                           */
#[inline]
unsafe extern "C" fn opj_dwt_encode_procedure(mut tp: *mut opj_thread_pool_t,
                                              mut tilec:
                                                  *mut opj_tcd_tilecomp_t,
                                              mut p_encode_and_deinterleave_v:
                                                  opj_encode_and_deinterleave_v_fnptr_type,
                                              mut p_encode_and_deinterleave_h_one_row:
 ...
 -> OPJ_BOOL {
    ...
    if l_data_size >
           (18446744073709551615 as
                libc::c_ulong).wrapping_div((8 as libc::c_int as
                                                 libc::c_ulong).wrapping_mul(::std::mem::size_of::<OPJ_INT32>()
                                                                                 as
                                                                                 libc::c_ulong))
       {
    ...
    loop  {
        let fresh50 =
            i; /* width of the resolution level once lower than computed one                                       */
        i =
            i -
                1; /* height of the resolution level once lower than computed one                                      */
        if !(fresh50 != 0) {
            break
        ...
        if num_threads <= 1 as libc::c_int ||
               rw < (2 as libc::c_int * 8 as libc::c_int) as libc::c_uint {
            ...
            while j.wrapping_add(8 as libc::c_int as
                                     libc::c_uint).wrapping_sub(1 as
                                                                    ...
                                                                    libc::c_uint)
                      < rw {
                p_encode_and_deinterleave_v.expect("non-null function pointer")(tiledp.offset(j
                                                                                                  as
                                                                                                  isize)
                                                                                    as
                                                                                    *mut libc::c_void,
            ...
            step_j =
                rw.wrapping_div(num_jobs).wrapping_div(8 as libc::c_int as
                                                           libc::c_uint).wrapping_mul(8
                                                                                          as
                                                                                          libc::c_int
                                                                                          as
            ...
            while j < num_jobs {
                let mut job = 0 as *mut opj_dwt_encode_v_job_t;
                job =
                    opj_malloc(::std::mem::size_of::<opj_dwt_encode_v_job_t>()
                                   as libc::c_ulong) as
                        *mut opj_dwt_encode_v_job_t;
                if job.is_null() {
                ...
                (*job).v.mem =
                    opj_aligned_32_malloc(l_data_size) as *mut OPJ_INT32;
                ...
                (*job).max_j =
                    if j.wrapping_add(1 as libc::c_int as libc::c_uint) ==
                        ...
                        j.wrapping_add(1 as libc::c_int as
                                           libc::c_uint).wrapping_mul(step_j)
                    };
                (*job).p_encode_and_deinterleave_v =
                    p_encode_and_deinterleave_v;
                opj_thread_pool_submit_job(tp,
                                           Some(opj_dwt_encode_v_func as
        ...
        if num_threads <= 1 as libc::c_int ||
               rh <= 1 as libc::c_int as libc::c_uint {
            j = 0 as libc::c_int as OPJ_UINT32; /* this can overflow */
            while j < rh {
                let mut aj = tiledp.offset(j.wrapping_mul(w) as isize);
                Some(p_encode_and_deinterleave_h_one_row.expect("non-null function pointer")).expect("non-null function pointer")(aj
                                                                                                                                      as
                                                                                                                                      *mut libc::c_void,
                                                                                                                                  bj
                                                                                                                                      as
            ...
            if rh < num_jobs_0 { num_jobs_0 = rh }
            step_j_0 = rh.wrapping_div(num_jobs_0);
            j = 0 as libc::c_int as OPJ_UINT32;
            while j < num_jobs_0 {
                let mut job_0 = 0 as *mut opj_dwt_encode_h_job_t;
                job_0 =
                    opj_malloc(::std::mem::size_of::<opj_dwt_encode_h_job_t>()
                                   as libc::c_ulong) as
                        *mut opj_dwt_encode_h_job_t;
                if job_0.is_null() {
                    opj_thread_pool_wait_completion(tp, 0 as libc::c_int);
                    opj_aligned_free(bj as *mut libc::c_void);
                    return 0 as libc::c_int
                ...
                (*job_0).max_j =
                    j.wrapping_add(1 as libc::c_uint).wrapping_mul(step_j_0);
...
/* </summary>                           */
#[no_mangle]
pub unsafe extern "C" fn opj_dwt_encode(mut p_tcd: *mut opj_tcd_t,
                                        mut tilec: *mut opj_tcd_tilecomp_t)
 -> OPJ_BOOL {
    return opj_dwt_encode_procedure((*p_tcd).thread_pool, tilec,
                                    Some(opj_dwt_encode_and_deinterleave_v as
                                             unsafe extern "C" fn(_:
                                                                      *mut libc::c_void,
                                                                  _:
                                                                      *mut libc::c_void,
                                                                  ...
                                                                  _:
                                                                      OPJ_UINT32)
                                                 -> ()),
                                    Some(opj_dwt_encode_and_deinterleave_h_one_row
                                             as
                                             unsafe extern "C" fn(_:
                                                                      *mut libc::c_void,
                                                                  _:
...
/* </summary>                           */
#[no_mangle]
pub unsafe extern "C" fn opj_dwt_decode(mut p_tcd: *mut opj_tcd_t,
                                        mut tilec: *mut opj_tcd_tilecomp_t,
                                        mut numres: OPJ_UINT32) -> OPJ_BOOL {
    if (*p_tcd).whole_tile_decoding != 0 {
        return opj_dwt_decode_tile((*p_tcd).thread_pool, tilec, numres)
    } else { return opj_dwt_decode_partial_tile(tilec, numres) };
}
/* <summary>                */
/* Get norm of 5-3 wavelet. */
/* </summary>               */
#[no_mangle]
pub unsafe extern "C" fn opj_dwt_getnorm(mut level: OPJ_UINT32,
 ...
 -> OPJ_FLOAT64 {
    ...
    /* See https://github.com/uclouvain/openjpeg/issues/493 */
    if orient == 0 as libc::c_int as libc::c_uint &&
           level >= 10 as libc::c_int as libc::c_uint {
        level = 9 as libc::c_int as OPJ_UINT32
    } else if orient > 0 as libc::c_int as libc::c_uint &&
                  level >= 9 as libc::c_int as libc::c_uint {
...
/* </summary>                            */
#[no_mangle]
pub unsafe extern "C" fn opj_dwt_encode_real(mut p_tcd: *mut opj_tcd_t,
                                             mut tilec:
                                                 *mut opj_tcd_tilecomp_t)
 -> OPJ_BOOL {
    return opj_dwt_encode_procedure((*p_tcd).thread_pool, tilec,
                                    Some(opj_dwt_encode_and_deinterleave_v_real
                                             as
                                             unsafe extern "C" fn(_:
                                                                      *mut libc::c_void,
                                                                  _:
                                                                  ...
                                                                  _:
                                                                      OPJ_UINT32)
                                                 -> ()),
                                    Some(opj_dwt_encode_and_deinterleave_h_one_row_real
                                             as
                                             unsafe extern "C" fn(_:
                                                                      *mut libc::c_void,
                                                                  _:
...
/* </summary>               */
#[no_mangle]
pub unsafe extern "C" fn opj_dwt_getnorm_real(mut level: OPJ_UINT32,
                                              mut orient: OPJ_UINT32)
 -> OPJ_FLOAT64 {
    /* FIXME ! This is just a band-aid to avoid a buffer overflow */
    /* but the array should really be extended up to 33 resolution levels */
...
#[no_mangle]
pub unsafe extern "C" fn opj_dwt_calc_explicit_stepsizes(mut tccp:
                                                             *mut opj_tccp_t,
                                                         mut prec:
                                                             OPJ_UINT32) {
    ...
    numbands =
        (3 as libc::c_int as
             libc::c_uint).wrapping_mul((*tccp).numresolutions).wrapping_sub(2
                                                                                 as
                                                                                 libc::c_int
                                                                                 as
                                                                                 libc::c_uint);
    ...
    while bandno < numbands {
        ...
        resno =
            if bandno == 0 as libc::c_int as libc::c_uint {
                0 as libc::c_int as libc::c_uint
            } else {
                bandno.wrapping_sub(1 as libc::c_int as
        ...
        level =
            (*tccp).numresolutions.wrapping_sub(1 as libc::c_int as
                                                    libc::c_uint).wrapping_sub(resno);
        gain =
            if (*tccp).qmfbid == 0 as libc::c_int as libc::c_uint {
                0 as libc::c_int
            } else if orient == 0 as libc::c_int as libc::c_uint {
                0 as libc::c_int
                ...
                1 as libc::c_int
            } else { 2 as libc::c_int } as OPJ_UINT32;
        ...
        opj_dwt_encode_stepsize(floor(stepsize * 8192.0f64) as OPJ_INT32,
                                prec.wrapping_add(gain) as OPJ_INT32,
                                &mut *(*tccp).stepsizes.as_mut_ptr().offset(bandno
                                                                                as
                                                                                isize));
...
/* </summary>                            */
unsafe extern "C" fn opj_dwt_max_resolution(mut r: *mut opj_tcd_resolution_t,
                                            mut i: OPJ_UINT32) -> OPJ_UINT32 {
...
unsafe extern "C" fn opj_dwt_decode_h_func(mut user_data: *mut libc::c_void,
    ...
    j = (*job).min_j;
    while j < (*job).max_j {
        opj_idwt53_h(&mut (*job).h,
                     &mut *(*job).tiledp.offset(j.wrapping_mul((*job).w) as
                                                    isize));
        j = j.wrapping_add(1)
    }
    opj_aligned_free((*job).h.mem as *mut libc::c_void);
...
unsafe extern "C" fn opj_dwt_decode_v_func(mut user_data: *mut libc::c_void,
    ...
    j = (*job).min_j;
    while j.wrapping_add((2 as libc::c_int * 4 as libc::c_int) as
                             libc::c_uint) <= (*job).max_j {
        opj_idwt53_v(&mut (*job).v, &mut *(*job).tiledp.offset(j as isize),
                     (*job).w as OPJ_SIZE_T,
...
/* Inverse wavelet transform in 2-D.    */
/* </summary>                           */
unsafe extern "C" fn opj_dwt_decode_tile(mut tp: *mut opj_thread_pool_t,
                                         mut tilec: *mut opj_tcd_tilecomp_t,
                                         mut numres: OPJ_UINT32) -> OPJ_BOOL {
    let mut h =
        opj_dwt_t{mem: 0 as *mut OPJ_INT32,
                  dn: 0,
                  sn: 0,
                  cas: 0,}; /* width of the resolution level computed */
    let mut v =
        opj_dwt_t{mem: 0 as *mut OPJ_INT32,
                  dn: 0,
                  sn: 0,
                  cas: 0,}; /* height of the resolution level computed */
    let mut tr = (*tilec).resolutions;
    let mut rw = ((*tr).x1 - (*tr).x0) as OPJ_UINT32;
    let mut rh = ((*tr).y1 - (*tr).y0) as OPJ_UINT32;
    let mut w =
        ((*(*tilec).resolutions.offset((*tilec).minimum_num_resolutions.wrapping_sub(1
                                                                                         as
                                                                                         libc::c_int
                                                                                         as
                                                                                         libc::c_uint)
             ...
             (*(*tilec).resolutions.offset((*tilec).minimum_num_resolutions.wrapping_sub(1
                                                                                             ...
                                                                                             as
                                                                                             libc::c_uint)
                                               as isize)).x0) as OPJ_UINT32;
    let mut h_mem_size: OPJ_SIZE_T = 0;
    let mut num_threads: libc::c_int = 0;
    if numres == 1 as libc::c_uint { return 1 as libc::c_int }
    ...
    loop  {
        ...
        if num_threads <= 1 as libc::c_int ||
            ...
            while j < rh {
                opj_idwt53_h(&mut h,
                             &mut *tiledp.offset((j as
                                                      OPJ_SIZE_T).wrapping_mul(w
                                                                                   as
                                                                                   libc::c_ulong)
                                                     as isize));
                j = j.wrapping_add(1)
            ...
            while j < num_jobs {
                let mut job = 0 as *mut opj_dwt_decode_h_job_t;
                job =
                    opj_malloc(::std::mem::size_of::<opj_dwt_decode_h_job_t>()
                                   as libc::c_ulong) as
                        *mut opj_dwt_decode_h_job_t;
                if job.is_null() {
                    ...
                    /* FIXME event manager error callback */
                    opj_thread_pool_wait_completion(tp,
                                                    0 as
                                                        libc::c_int); /* this can overflow */
                ...
                (*job).min_j = j.wrapping_mul(step_j);
                (*job).max_j =
                    j.wrapping_add(1 as libc::c_uint).wrapping_mul(step_j);
                if j == num_jobs.wrapping_sub(1 as libc::c_uint) {
                    /* this will take care of the overflow */
                    (*job).max_j = rh
                }
                (*job).h.mem =
                    opj_aligned_32_malloc(h_mem_size) as *mut OPJ_INT32;
        ...
        if num_threads <= 1 as libc::c_int ||
               rw <= 1 as libc::c_int as libc::c_uint {
            j = 0 as libc::c_int as OPJ_UINT32;
            while j.wrapping_add((2 as libc::c_int * 4 as libc::c_int) as
                                     libc::c_uint) <= rw {
                opj_idwt53_v(&mut v, &mut *tiledp.offset(j as isize),
                             w as OPJ_SIZE_T,
                             2 as libc::c_int * 4 as libc::c_int);
                j =
                    (j as
            ...
            let mut num_jobs_0 = num_threads as OPJ_UINT32;
            let mut step_j_0: OPJ_UINT32 = 0;
            if rw < num_jobs_0 { num_jobs_0 = rw }
            step_j_0 = rw.wrapping_div(num_jobs_0);
            j = 0 as libc::c_int as OPJ_UINT32;
            while j < num_jobs_0 {
                let mut job_0 = 0 as *mut opj_dwt_decode_v_job_t;
                job_0 =
                    opj_malloc(::std::mem::size_of::<opj_dwt_decode_v_job_t>()
                                   as libc::c_ulong) as
                        *mut opj_dwt_decode_v_job_t;
                if job_0.is_null() {
                    /* It would be nice to fallback to single thread case, but */
                    /* unfortunately some jobs may be launched and have modified */
                    /* tiledp, so it is not practical to recover from that error */
...
unsafe extern "C" fn opj_dwt_interleave_partial_h(mut dest: *mut OPJ_INT32,
                                                  mut cas: OPJ_INT32,
                                                  mut sa:
                                                      *mut opj_sparse_array_int32_t,
    ...
    ret =
        opj_sparse_array_int32_read(sa, win_l_x0, sa_line, win_l_x1,
                                    sa_line.wrapping_add(1 as libc::c_int as
                                                             libc::c_uint),
                                    dest.offset(cas as
                                                    isize).offset((2 as
                                                                       libc::c_int
                                                                       as
                                                                       libc::c_uint).wrapping_mul(win_l_x0)
                                                                      as
                                                                      isize),
    ...
    if ret != 0 {
        ...
        __assert_fail(b"ret\x00" as *const u8 as *const libc::c_char,
                      ...
                      (*::std::mem::transmute::<&[u8; 158],
                                                &[libc::c_char; 158]>(b"void opj_dwt_interleave_partial_h(OPJ_INT32 *, OPJ_INT32, opj_sparse_array_int32_t *, OPJ_UINT32, OPJ_UINT32, OPJ_UINT32, OPJ_UINT32, OPJ_UINT32, OPJ_UINT32)\x00")).as_ptr());
    }
    ret =
        opj_sparse_array_int32_read(sa, sn.wrapping_add(win_h_x0), sa_line,
                                    sn.wrapping_add(win_h_x1),
                                    sa_line.wrapping_add(1 as libc::c_int as
                                                             libc::c_uint),
                                    dest.offset(1 as libc::c_int as
                                                    isize).offset(-(cas as
                                                                        isize)).offset((2
                                                                                            as
                                                                                            libc::c_int
                                                                                            as
                                                                                            libc::c_uint).wrapping_mul(win_h_x0)
                                                                                           as
                                                                                           isize),
                                    2 as libc::c_int as OPJ_UINT32,
                                    0 as libc::c_int as OPJ_UINT32,
...
unsafe extern "C" fn opj_dwt_interleave_partial_v(mut dest: *mut OPJ_INT32,
                                                  mut cas: OPJ_INT32,
                                                  mut sa:
                                                      *mut opj_sparse_array_int32_t,
    ...
    let mut ret: OPJ_BOOL = 0;
    ret =
        opj_sparse_array_int32_read(sa, sa_col, win_l_y0,
                                    sa_col.wrapping_add(nb_cols), win_l_y1,
                                    dest.offset((cas * 4 as libc::c_int) as
                                                    isize).offset(((2 as
                                                                        libc::c_int
                                                                        *
                                                                        4 as
                                                                            libc::c_int)
                                                                       as
                                                                       libc::c_uint).wrapping_mul(win_l_y0)
                                                                      as
                                                                      isize),
                                    1 as libc::c_int as OPJ_UINT32,
                                    (2 as libc::c_int * 4 as libc::c_int) as
                                        OPJ_UINT32, 1 as libc::c_int);
    if ret != 0 {
    } else {
        __assert_fail(b"ret\x00" as *const u8 as *const libc::c_char,
                      b"/opt/openjpeg/src/lib/openjp2/dwt.c\x00" as *const u8
                          as *const libc::c_char,
                      2272 as libc::c_int as libc::c_uint,
                      (*::std::mem::transmute::<&[u8; 170],
                                                &[libc::c_char; 170]>(b"void opj_dwt_interleave_partial_v(OPJ_INT32 *, OPJ_INT32, opj_sparse_array_int32_t *, OPJ_UINT32, OPJ_UINT32, OPJ_UINT32, OPJ_UINT32, OPJ_UINT32, OPJ_UINT32, OPJ_UINT32)\x00")).as_ptr());
    }
    ret =
        opj_sparse_array_int32_read(sa, sa_col, sn.wrapping_add(win_h_y0),
                                    sa_col.wrapping_add(nb_cols),
                                    sn.wrapping_add(win_h_y1),
                                    dest.offset(((1 as libc::c_int - cas) *
                                                     4 as libc::c_int) as
                                                    isize).offset(((2 as
                                                                        libc::c_int
                                                                        *
                                                                        4 as
                                                                            libc::c_int)
                                                                       as
                                                                       libc::c_uint).wrapping_mul(win_h_y0)
                                                                      as
                                                                      isize),
                                    1 as libc::c_int as OPJ_UINT32,
                                    (2 as libc::c_int * 4 as libc::c_int) as
...
unsafe extern "C" fn opj_dwt_decode_partial_1(mut a: *mut OPJ_INT32,
                                              mut dn: OPJ_INT32,
                                              mut sn: OPJ_INT32,
                                              mut cas: OPJ_INT32,
        ...
        if dn > 0 as libc::c_int || sn > 1 as libc::c_int {
            ...
            */
            ...
            if i < win_h_x1 {
                ...
                if i_max_0 >= sn { i_max_0 = sn - 1 as libc::c_int }
                while i < i_max_0 {
                    /* No bound checking */
                    let ref mut fresh54 =
                        *a.offset((1 as libc::c_int + i * 2 as libc::c_int) as
...
unsafe extern "C" fn opj_dwt_decode_partial_1_parallel(mut a: *mut OPJ_INT32,
    ...
    if cas == 0 {
            ...
            */
            ...
            if i < win_l_x1 {
                ...
                while off < 4 as libc::c_int as libc::c_uint {
                    ...
                    *fresh57 -=
                        (if (i - 1 as libc::c_int) < 0 as libc::c_int {
                             *a.offset((1 as libc::c_int as
                                            libc::c_uint).wrapping_add((0 as
                                                                            libc::c_int
                                                                            as
                                                                            OPJ_UINT32).wrapping_mul(2
                                                                                                         as
                                                                                                         libc::c_int
                                                                                                         as
                                                                                                         libc::c_uint)).wrapping_mul(4
                        ...
                        *fresh61 +=
                            (if i < 0 as libc::c_int {
                                 *a.offset((0 as libc::c_int as
                                 ...
                                 (if i >= sn {
                                      *a.offset(((sn - 1 as libc::c_int) as
                                                     OPJ_UINT32).wrapping_mul(2
                                                                                  as
                                                                                  libc::c_int
                                                                                  as
        ...
        while off < 4 as libc::c_int as libc::c_uint {
            let ref mut fresh62 =
                *a.offset((0 as libc::c_int as
                               OPJ_UINT32).wrapping_mul(2 as libc::c_int as
                                                            libc::c_uint).wrapping_mul(4
                                                                                           as
                                                                                           libc::c_int
                                                                                           as
                               ...
                               libc::c_uint).wrapping_add((i as
                                                               OPJ_UINT32).wrapping_mul(2
                                                                                            ...
                                                                                            libc::c_uint)).wrapping_mul(4
                                                                                                                            ...
                                                                                                                            libc::c_uint).wrapping_add(off)
                              as isize) =
                    opj_int_sub_no_overflow(*a.offset((1 as libc::c_int as
                                                           libc::c_uint).wrapping_add((i
                                                                                           as
                                                                                           OPJ_UINT32).wrapping_mul(2
                                                                                                                        as
                ...
                *a.offset((i as
                               OPJ_UINT32).wrapping_mul(2 as libc::c_int as
                                                            libc::c_uint).wrapping_mul(4
                                                                                           ...
                                                                                           libc::c_uint).wrapping_add(off)
                              as isize) =
                    opj_int_add_no_overflow(*a.offset((i as
                                                           OPJ_UINT32).wrapping_mul(2
                                                                                        as
                                                                                        libc::c_int
                                                                                        as
...
unsafe extern "C" fn opj_dwt_get_band_coordinates(mut tilec:
                                                      *mut opj_tcd_tilecomp_t,
    ...
    let mut nb =
        if resno == 0 as libc::c_int as libc::c_uint {
            (*tilec).numresolutions.wrapping_sub(1 as libc::c_int as
                                                     libc::c_uint)
        } else { (*tilec).numresolutions.wrapping_sub(resno) };
    ...
    if !tbx0.is_null() {
        *tbx0 =
            if nb == 0 as libc::c_int as libc::c_uint {
                tcx0
            } else if tcx0 <=
                          ((1 as libc::c_uint) <<
                               nb.wrapping_sub(1 as libc::c_int as
                                                   libc::c_uint)).wrapping_mul(x0b)
             {
                0 as libc::c_int as libc::c_uint
            } else {
                opj_uint_ceildivpow2(tcx0.wrapping_sub(((1 as libc::c_uint) <<
                                                            nb.wrapping_sub(1
                                                                                as
                                                                                libc::c_int
                                                                                as
        ...
        *tby0 =
            if nb == 0 as libc::c_int as libc::c_uint {
                tcy0
                          ...
                          ((1 as libc::c_uint) <<
                               nb.wrapping_sub(1 as libc::c_int as
                                                   libc::c_uint)).wrapping_mul(y0b)
             {
                0 as libc::c_int as libc::c_uint
            } else {
                opj_uint_ceildivpow2(tcy0.wrapping_sub(((1 as libc::c_uint) <<
                                                            nb.wrapping_sub(1
                                                                                as
                                                                                libc::c_int
                                                                                as
        ...
        *tbx1 =
            if nb == 0 as libc::c_int as libc::c_uint {
                                                   ...
                                                   libc::c_uint)).wrapping_mul(x0b)
             {
                ...
                opj_uint_ceildivpow2(tcx1.wrapping_sub(((1 as libc::c_uint) <<
                                                            nb.wrapping_sub(1
                                                                                as
                                                                                libc::c_int
                                                                                as
        ...
        *tby1 =
            if nb == 0 as libc::c_int as libc::c_uint {
                                                   ...
                                                   libc::c_uint)).wrapping_mul(y0b)
             {
                ...
                opj_uint_ceildivpow2(tcy1.wrapping_sub(((1 as libc::c_uint) <<
                                                            nb.wrapping_sub(1
                                                                                as
                                                                                libc::c_int
                                                                                as
...
unsafe extern "C" fn opj_dwt_segment_grow(mut filter_width: OPJ_UINT32,
...
unsafe extern "C" fn opj_dwt_init_sparse_array(mut tilec:
                                                   *mut opj_tcd_tilecomp_t,
                                               mut numres: OPJ_UINT32)
 -> *mut opj_sparse_array_int32_t {
    let mut tr_max: *mut opj_tcd_resolution_t =
        &mut *(*tilec).resolutions.offset(numres.wrapping_sub(1 as libc::c_int
                                                                  as
                                                                  libc::c_uint)
                                              as isize) as
    ...
    let mut sa =
        opj_sparse_array_int32_create(w, h,
                                      opj_uint_min(w,
                                                   64 as libc::c_int as
                                                       OPJ_UINT32),
                                      opj_uint_min(h,
                                                   64 as libc::c_int as
                                                       OPJ_UINT32));
    if sa.is_null() { return 0 as *mut opj_sparse_array_int32_t }
    ...
    while resno < numres {
        ...
        while bandno < (*res).numbands {
            let mut band: *mut opj_tcd_band_t =
                &mut *(*res).bands.as_mut_ptr().offset(bandno as isize) as
                    *mut opj_tcd_band_t;
            ...
            while precno < (*res).pw.wrapping_mul((*res).ph) {
                ...
                while cblkno < (*precinct).cw.wrapping_mul((*precinct).ch) {
                    let mut cblk: *mut opj_tcd_cblk_dec_t =
                        &mut *(*precinct).cblks.dec.offset(cblkno as isize) as
                    ...
                    if !(*cblk).decoded_data.is_null() {
                        ...
                        if (*band).bandno & 1 as libc::c_int as libc::c_uint
                               != 0 {
                            let mut pres: *mut opj_tcd_resolution_t =
                                &mut *(*tilec).resolutions.offset(resno.wrapping_sub(1
                                                                                         as
                                                                                         libc::c_int
                                                                                         as
                                                                                         libc::c_uint)
                            ...
                            x =
                                (x as
                                     libc::c_uint).wrapping_add(((*pres).x1 -
                                                                     (*pres).x0)
                                                                    as
                                                                    OPJ_UINT32)
                                    as OPJ_UINT32 as OPJ_UINT32
                        }
                        if (*band).bandno & 2 as libc::c_int as libc::c_uint
                               != 0 {
                            ...
                            y =
                                (y as
                                     libc::c_uint).wrapping_add(((*pres_0).y1
                                                                     -
                                                                     (*pres_0).y0)
                                                                    as
                                                                    OPJ_UINT32)
...
unsafe extern "C" fn opj_dwt_decode_partial_tile(mut tilec:
                                                     *mut opj_tcd_tilecomp_t,
                                                 mut numres: OPJ_UINT32)
 -> OPJ_BOOL {
    let mut sa = 0 as *mut opj_sparse_array_int32_t;
    let mut h = opj_dwt_t{mem: 0 as *mut OPJ_INT32, dn: 0, sn: 0, cas: 0,};
    let mut v = opj_dwt_t{mem: 0 as *mut OPJ_INT32, dn: 0, sn: 0, cas: 0,};
    let mut resno: OPJ_UINT32 = 0;
    /* This value matches the maximum left/right extension given in tables */
    /* F.2 and F.3 of the standard. */
    let filter_width =
        2 as libc::c_uint; /* width of the resolution level computed */
    let mut tr =
        (*tilec).resolutions; /* height of the resolution level computed */
    let mut tr_max: *mut opj_tcd_resolution_t =
        &mut *(*tilec).resolutions.offset(numres.wrapping_sub(1 as libc::c_int
                                                                  as
                                                                  libc::c_uint)
    ...
    if sa.is_null() { return 0 as libc::c_int }
    if numres == 1 as libc::c_uint {
        let mut ret =
            opj_sparse_array_int32_read(sa,
                                        (*tr_max).win_x0.wrapping_sub((*tr_max).x0
                                                                          as
                                                                          OPJ_UINT32),
                                        (*tr_max).win_y0.wrapping_sub((*tr_max).y0
                                                                          as
                                                                          OPJ_UINT32),
                                        (*tr_max).win_x1.wrapping_sub((*tr_max).x0
                                                                          as
                                                                          OPJ_UINT32),
                                        (*tr_max).win_y1.wrapping_sub((*tr_max).y0
                                                                          as
                                                                          OPJ_UINT32),
                                        (*tilec).data_win,
                                        1 as libc::c_int as OPJ_UINT32,
        ...
        if ret != 0 {
            ...
            __assert_fail(b"ret\x00" as *const u8 as *const libc::c_char,
                          b"/opt/openjpeg/src/lib/openjp2/dwt.c\x00" as
                              *const u8 as *const libc::c_char,
                          2665 as libc::c_int as libc::c_uint,
                          (*::std::mem::transmute::<&[u8; 71],
                                                    &[libc::c_char; 71]>(b"OPJ_BOOL opj_dwt_decode_partial_tile(opj_tcd_tilecomp_t *, OPJ_UINT32)\x00")).as_ptr());
        }
        opj_sparse_array_int32_free(sa);
        return 1 as libc::c_int
    }
    ...
    while resno < numres {
        ...
        opj_dwt_get_band_coordinates(tilec, resno,
                                     0 as libc::c_int as OPJ_UINT32, win_tcx0,
                                     win_tcy0, win_tcx1, win_tcy1,
                                     &mut win_ll_x0, &mut win_ll_y0,
                                     &mut win_ll_x1, &mut win_ll_y1);
        /* HL band */
        opj_dwt_get_band_coordinates(tilec, resno,
                                     1 as libc::c_int as OPJ_UINT32, win_tcx0,
                                     win_tcy0, win_tcx1, win_tcy1,
                                     &mut win_hl_x0, 0 as *mut OPJ_UINT32,
                                     &mut win_hl_x1, 0 as *mut OPJ_UINT32);
        /* LH band */
        opj_dwt_get_band_coordinates(tilec, resno,
                                     2 as libc::c_int as OPJ_UINT32, win_tcx0,
                                     win_tcy0, win_tcx1, win_tcy1,
                                     0 as *mut OPJ_UINT32, &mut win_lh_y0,
                                     0 as *mut OPJ_UINT32, &mut win_lh_y1);
        ...
        opj_dwt_segment_grow(filter_width, h.sn as OPJ_UINT32, &mut win_ll_x0,
                             &mut win_ll_x1);
        opj_dwt_segment_grow(filter_width, h.dn as OPJ_UINT32, &mut win_hl_x0,
                             &mut win_hl_x1);
        opj_dwt_segment_grow(filter_width, v.sn as OPJ_UINT32, &mut win_ll_y0,
                             &mut win_ll_y1);
        opj_dwt_segment_grow(filter_width, v.dn as OPJ_UINT32, &mut win_lh_y0,
                             &mut win_lh_y1);
        /* Compute the tile-resolution-based coordinates for the window of interest */
        if h.cas == 0 as libc::c_int {
            win_tr_x0 =
                opj_uint_min((2 as libc::c_int as
                                  libc::c_uint).wrapping_mul(win_ll_x0),
                             (2 as libc::c_int as
                                  libc::c_uint).wrapping_mul(win_hl_x0).wrapping_add(1
                                                                                         as
                                                                                         libc::c_int
                                                                                         as
                                                                                         libc::c_uint));
            win_tr_x1 =
                opj_uint_min(opj_uint_max((2 as libc::c_int as
                                               libc::c_uint).wrapping_mul(win_ll_x1),
                                          (2 as libc::c_int as
                                               libc::c_uint).wrapping_mul(win_hl_x1).wrapping_add(1
                                                                                                      as
                                                                                                      libc::c_int
                                                                                                      as
                                                                                                      libc::c_uint)),
            ...
            win_tr_x0 =
                opj_uint_min((2 as libc::c_int as
                                  libc::c_uint).wrapping_mul(win_hl_x0),
                             (2 as libc::c_int as
                                  libc::c_uint).wrapping_mul(win_ll_x0).wrapping_add(1
                                                                                         as
                                                                                         libc::c_int
                                                                                         as
                                                                                         libc::c_uint));
            win_tr_x1 =
                opj_uint_min(opj_uint_max((2 as libc::c_int as
                                               libc::c_uint).wrapping_mul(win_hl_x1),
                                          (2 as libc::c_int as
                                               libc::c_uint).wrapping_mul(win_ll_x1).wrapping_add(1
                                                                                                      as
                                                                                                      libc::c_int
                                                                                                      as
                                                                                                      libc::c_uint)),
        ...
        if v.cas == 0 as libc::c_int {
            win_tr_y0 =
                opj_uint_min((2 as libc::c_int as
                                  libc::c_uint).wrapping_mul(win_ll_y0),
                             (2 as libc::c_int as
                                  libc::c_uint).wrapping_mul(win_lh_y0).wrapping_add(1
                                                                                         as
                                                                                         libc::c_int
                                                                                         as
                                                                                         libc::c_uint));
            win_tr_y1 =
                opj_uint_min(opj_uint_max((2 as libc::c_int as
                                               libc::c_uint).wrapping_mul(win_ll_y1),
                                          (2 as libc::c_int as
                                               libc::c_uint).wrapping_mul(win_lh_y1).wrapping_add(1
                                                                                                      as
                                                                                                      libc::c_int
                                                                                                      as
                                                                                                      libc::c_uint)),
            ...
            win_tr_y0 =
                opj_uint_min((2 as libc::c_int as
                                  libc::c_uint).wrapping_mul(win_lh_y0),
                             (2 as libc::c_int as
                                  libc::c_uint).wrapping_mul(win_ll_y0).wrapping_add(1
                                                                                         as
                                                                                         libc::c_int
                                                                                         as
                                                                                         libc::c_uint));
            win_tr_y1 =
                opj_uint_min(opj_uint_max((2 as libc::c_int as
                                               libc::c_uint).wrapping_mul(win_lh_y1),
                                          (2 as libc::c_int as
                                               libc::c_uint).wrapping_mul(win_ll_y1).wrapping_add(1
                                                                                                      as
                                                                                                      libc::c_int
                                                                                                      as
                                                                                                      libc::c_uint)),
        ...
        while j < rh {
            if j >= win_ll_y0 && j < win_ll_y1 ||
                ...
                if win_tr_x1 >= 1 as libc::c_int as libc::c_uint &&
                       win_tr_x1 < rw {
                    *h.mem.offset(win_tr_x1.wrapping_sub(1 as libc::c_int as
                                                             libc::c_uint) as
                ...
                opj_dwt_interleave_partial_h(h.mem, h.cas, sa, j,
                                             h.sn as OPJ_UINT32, win_ll_x0,
                ...
                if opj_sparse_array_int32_write(sa, win_tr_x0, j, win_tr_x1,
                                                j.wrapping_add(1 as
                                                                   libc::c_int
                                                                   as
                                                                   libc::c_uint),
                                                h.mem.offset(win_tr_x0 as
                                                                 isize),
                                                1 as libc::c_int as
                                                    OPJ_UINT32,
                                                0 as libc::c_int as
        ...
        while i < win_tr_x1 {
            let mut nb_cols =
                opj_uint_min(4 as libc::c_uint, win_tr_x1.wrapping_sub(i));
            opj_dwt_interleave_partial_v(v.mem, v.cas, sa, i, nb_cols,
                                         v.sn as OPJ_UINT32, win_ll_y0,
                                         win_ll_y1, win_lh_y0, win_lh_y1);
            opj_dwt_decode_partial_1_parallel(v.mem, nb_cols, v.dn, v.sn,
                                              v.cas, win_ll_y0 as OPJ_INT32,
                                              win_ll_y1 as OPJ_INT32,
                                              win_lh_y0 as OPJ_INT32,
                                              win_lh_y1 as OPJ_INT32);
            if opj_sparse_array_int32_write(sa, i, win_tr_y0,
                                            i.wrapping_add(nb_cols),
                                            win_tr_y1,
                                            v.mem.offset((4 as libc::c_int as
                                                              libc::c_uint).wrapping_mul(win_tr_y0)
                                                             as isize),
                                            1 as libc::c_int as OPJ_UINT32,
            ...
            i =
                (i as libc::c_uint).wrapping_add(nb_cols) as OPJ_UINT32 as
                    OPJ_UINT32
        }
        resno = resno.wrapping_add(1)
    }
...
unsafe extern "C" fn opj_v8dwt_interleave_h(mut dwt: *mut opj_v8dwt_t,
                                            mut a: *mut OPJ_FLOAT32,
                                            mut width: OPJ_UINT32,
                                            mut remaining_height:
                                                OPJ_UINT32) {
    let mut bi =
        (*dwt).wavelet.offset((*dwt).cas as isize) as *mut OPJ_FLOAT32;
    let mut i: OPJ_UINT32 = 0;
    let mut k: OPJ_UINT32 = 0;
    ...
    while k < 2 as libc::c_int as libc::c_uint {
        if remaining_height >= 8 as libc::c_int as libc::c_uint &&
               a as OPJ_SIZE_T & 0xf as libc::c_int as libc::c_ulong ==
                   0 as libc::c_int as libc::c_ulong &&
               bi as OPJ_SIZE_T & 0xf as libc::c_int as libc::c_ulong ==
                   0 as libc::c_int as libc::c_ulong {
            /* Fast code path */
            i = x0;
            while i < x1 {
                let mut j = i;
                let mut dst =
                    bi.offset(i.wrapping_mul(2 as libc::c_int as
                                                 libc::c_uint).wrapping_mul(8
                                                                                as
                                                                                libc::c_int
                                                                                as
                ...
                *dst.offset(0 as libc::c_int as isize) =
                    *a.offset(j as isize);
                j =
                    (j as libc::c_uint).wrapping_add(width) as OPJ_UINT32 as
                        OPJ_UINT32;
                ...
                let mut dst_0 =
                    bi.offset(i.wrapping_mul(2 as libc::c_int as
                                                 libc::c_uint).wrapping_mul(8
                                                                                ...
                                                                                libc::c_uint)
                                  as isize);
                *dst_0.offset(0 as libc::c_int as isize) =
                    *a.offset(j_0 as isize);
                j_0 =
                    (j_0 as libc::c_uint).wrapping_add(width) as OPJ_UINT32 as
                        OPJ_UINT32;
                if !(remaining_height == 1 as libc::c_int as libc::c_uint) {
                    *dst_0.offset(1 as libc::c_int as isize) =
                        *a.offset(j_0 as isize);
                    j_0 =
                        (j_0 as libc::c_uint).wrapping_add(width) as
                            OPJ_UINT32 as OPJ_UINT32;
                    if !(remaining_height == 2 as libc::c_int as libc::c_uint)
                       {
                        *dst_0.offset(2 as libc::c_int as isize) =
                            *a.offset(j_0 as isize);
                        j_0 =
                            (j_0 as libc::c_uint).wrapping_add(width) as
                                OPJ_UINT32 as OPJ_UINT32;
                        if !(remaining_height ==
                            ...
                            *dst_0.offset(3 as libc::c_int as isize) =
                                *a.offset(j_0 as isize);
                            j_0 =
                                (j_0 as libc::c_uint).wrapping_add(width) as
                                    OPJ_UINT32 as OPJ_UINT32;
                            if !(remaining_height ==
                                ...
                                *dst_0.offset(4 as libc::c_int as isize) =
                                    *a.offset(j_0 as isize);
                                j_0 =
                                    (j_0 as libc::c_uint).wrapping_add(width)
                                        as OPJ_UINT32 as OPJ_UINT32;
                                if !(remaining_height ==
                                         5 as libc::c_int as libc::c_uint) {
                                    *dst_0.offset(5 as libc::c_int as isize) =
                                        *a.offset(j_0 as isize);
                                    j_0 =
                                        (j_0 as
                                    ...
                                    if !(remaining_height ==
                                       ...
                                       {
                                        *dst_0.offset(6 as libc::c_int as
                                                          isize) =
                                            *a.offset(j_0 as isize);
                                        j_0 =
                                            (j_0 as
                                        ...
                                        if !(remaining_height ==
                                                 7 as libc::c_int as
                                                     libc::c_uint) {
                                            *dst_0.offset(7 as libc::c_int as
                                                              isize) =
                                                *a.offset(j_0 as isize)
                                        }
                                    }
        ...
        bi =
            (*dwt).wavelet.offset(1 as libc::c_int as
                                      isize).offset(-((*dwt).cas as isize)) as
                *mut OPJ_FLOAT32;
...
unsafe extern "C" fn opj_v8dwt_interleave_partial_h(mut dwt: *mut opj_v8dwt_t,
                                                    mut sa:
                                                        *mut opj_sparse_array_int32_t,
                                                    mut sa_line: OPJ_UINT32,
                                                    mut remaining_height:
    ...
    while i < remaining_height {
        let mut ret: OPJ_BOOL = 0;
        ret =
            opj_sparse_array_int32_read(sa, (*dwt).win_l_x0,
                                        sa_line.wrapping_add(i),
                                        (*dwt).win_l_x1,
                                        sa_line.wrapping_add(i).wrapping_add(1
                                                                                 as
                                                                                 libc::c_int
                                                                                 as
                                                                                 libc::c_uint),
                                        ((*dwt).wavelet.offset((*dwt).cas as
                                                                   isize).offset((2
                                                                                      as
                                                                                      libc::c_int
                                                                                      as
                                                                                      libc::c_uint).wrapping_mul((*dwt).win_l_x0)
                                                                                     as
                                                                                     isize)
                                             as
                                             *mut OPJ_INT32).offset(i as
                                                                        isize),
        ...
        if ret != 0 {
            ...
            __assert_fail(b"ret\x00" as *const u8 as *const libc::c_char,
                          ...
                          (*::std::mem::transmute::<&[u8; 103],
                                                    &[libc::c_char; 103]>(b"void opj_v8dwt_interleave_partial_h(opj_v8dwt_t *, opj_sparse_array_int32_t *, OPJ_UINT32, OPJ_UINT32)\x00")).as_ptr());
        }
        ret =
            opj_sparse_array_int32_read(sa,
                                        ((*dwt).sn as
                                             OPJ_UINT32).wrapping_add((*dwt).win_h_x0),
                                        sa_line.wrapping_add(i),
                                        ((*dwt).sn as
                                             OPJ_UINT32).wrapping_add((*dwt).win_h_x1),
                                        sa_line.wrapping_add(i).wrapping_add(1
                                                                                 as
                                                                                 libc::c_int
                                                                                 as
                                                                                 libc::c_uint),
                                        ((*dwt).wavelet.offset(1 as
                                                                   libc::c_int
                                                                   as
                                                                   isize).offset(-((*dwt).cas
                                                                                       as
                                                                                       isize)).offset((2
                                                                                                           as
                                                                                                           libc::c_int
                                                                                                           as
                                                                                                           libc::c_uint).wrapping_mul((*dwt).win_h_x0)
                                                                                                          as
                                                                                                          isize)
                                             as
                                             *mut OPJ_INT32).offset(i as
...
#[inline]
unsafe extern "C" fn opj_v8dwt_interleave_v(mut dwt: *mut opj_v8dwt_t,
                                            mut a: *mut OPJ_FLOAT32,
                                            mut width: OPJ_UINT32,
    ...
    while i < (*dwt).win_l_x1 {
        memcpy(&mut *bi.offset(i.wrapping_mul(2 as libc::c_int as
                                                  libc::c_uint) as isize) as
                   *mut opj_v8_t as *mut libc::c_void,
               &mut *a.offset((i as
                                   libc::c_ulong).wrapping_mul(width as
                                                                   OPJ_SIZE_T)
                                  as isize) as *mut OPJ_FLOAT32 as
                   *const libc::c_void,
               (nb_elts_read as
                    OPJ_SIZE_T).wrapping_mul(::std::mem::size_of::<OPJ_FLOAT32>()
                                                 as libc::c_ulong));
        i = i.wrapping_add(1)
    }
    a =
        a.offset(((*dwt).sn as OPJ_UINT32 as
                      libc::c_ulong).wrapping_mul(width as OPJ_SIZE_T) as
                     isize);
    bi =
        (*dwt).wavelet.offset(1 as libc::c_int as
                                  isize).offset(-((*dwt).cas as isize));
    i = (*dwt).win_h_x0;
...
unsafe extern "C" fn opj_v8dwt_interleave_partial_v(mut dwt: *mut opj_v8dwt_t,
                                                    mut sa:
                                                        *mut opj_sparse_array_int32_t,
                                                    mut sa_col: OPJ_UINT32,
                                                    mut nb_elts_read:
    ...
    let mut ret: OPJ_BOOL = 0;
    ret =
        opj_sparse_array_int32_read(sa, sa_col, (*dwt).win_l_x0,
    ...
    if ret != 0 {
        ...
        __assert_fail(b"ret\x00" as *const u8 as *const libc::c_char,
                      b"/opt/openjpeg/src/lib/openjp2/dwt.c\x00" as *const u8
                          as *const libc::c_char,
                      3007 as libc::c_int as libc::c_uint,
                      (*::std::mem::transmute::<&[u8; 111],
                                                &[libc::c_char; 111]>(b"void opj_v8dwt_interleave_partial_v(opj_v8dwt_t *restrict, opj_sparse_array_int32_t *, OPJ_UINT32, OPJ_UINT32)\x00")).as_ptr());
    }
    ret =
        opj_sparse_array_int32_read(sa, sa_col,
                                    ((*dwt).sn as
                                         OPJ_UINT32).wrapping_add((*dwt).win_h_x0),
                                    sa_col.wrapping_add(nb_elts_read),
                                    ((*dwt).sn as
    ...
    if ret != 0 {
        ...
        __assert_fail(b"ret\x00" as *const u8 as *const libc::c_char,
                      b"/opt/openjpeg/src/lib/openjp2/dwt.c\x00" as *const u8
                          as *const libc::c_char,
                      3013 as libc::c_int as libc::c_uint,
                      (*::std::mem::transmute::<&[u8; 111],
                                                &[libc::c_char; 111]>(b"void opj_v8dwt_interleave_partial_v(opj_v8dwt_t *restrict, opj_sparse_array_int32_t *, OPJ_UINT32, OPJ_UINT32)\x00")).as_ptr());
    };
}
unsafe extern "C" fn opj_v8dwt_decode_step1(mut w: *mut opj_v8_t,
...
unsafe extern "C" fn opj_v8dwt_decode_step2(mut l: *mut opj_v8_t,
                                            mut w: *mut opj_v8_t,
                                            mut start: OPJ_UINT32,
                                            mut end: OPJ_UINT32,
                                            mut m: OPJ_UINT32,
    ...
    if start > 0 as libc::c_int as libc::c_uint {
        fw =
            fw.offset(((2 as libc::c_int * 8 as libc::c_int) as
                           libc::c_uint).wrapping_mul(start) as isize);
    ...
    while i < imax {
        ...
        *fw.offset(-(7 as libc::c_int) as isize) =
            *fw.offset(-(7 as libc::c_int) as isize) +
                (*fl.offset(1 as libc::c_int as isize) +
                     *fw.offset(1 as libc::c_int as isize)) * c;
        *fw.offset(-(6 as libc::c_int) as isize) =
            *fw.offset(-(6 as libc::c_int) as isize) +
                (*fl.offset(2 as libc::c_int as isize) +
                     *fw.offset(2 as libc::c_int as isize)) * c;
        *fw.offset(-(5 as libc::c_int) as isize) =
            *fw.offset(-(5 as libc::c_int) as isize) +
                (*fl.offset(3 as libc::c_int as isize) +
                     *fw.offset(3 as libc::c_int as isize)) * c;
        *fw.offset(-(4 as libc::c_int) as isize) =
            *fw.offset(-(4 as libc::c_int) as isize) +
                (*fl.offset(4 as libc::c_int as isize) +
                     *fw.offset(4 as libc::c_int as isize)) * c;
        *fw.offset(-(3 as libc::c_int) as isize) =
            *fw.offset(-(3 as libc::c_int) as isize) +
                (*fl.offset(5 as libc::c_int as isize) +
                     *fw.offset(5 as libc::c_int as isize)) * c;
        *fw.offset(-(2 as libc::c_int) as isize) =
            *fw.offset(-(2 as libc::c_int) as isize) +
                (*fl.offset(6 as libc::c_int as isize) +
                     *fw.offset(6 as libc::c_int as isize)) * c;
        *fw.offset(-(1 as libc::c_int) as isize) =
            *fw.offset(-(1 as libc::c_int) as isize) +
                (*fl.offset(7 as libc::c_int as isize) +
                     *fw.offset(7 as libc::c_int as isize)) * c;
        fl = fw;
        fw = fw.offset((2 as libc::c_int * 8 as libc::c_int) as isize);
        i = i.wrapping_add(1)
    }
    if m < end {
        if m.wrapping_add(1 as libc::c_int as libc::c_uint) == end {
            ...
            __assert_fail(b"m + 1 == end\x00" as *const u8 as
                          ...
                          b"/opt/openjpeg/src/lib/openjp2/dwt.c\x00" as
                              *const u8 as *const libc::c_char,
                          3122 as libc::c_int as libc::c_uint,
                          (*::std::mem::transmute::<&[u8; 101],
                                                    &[libc::c_char; 101]>(b"void opj_v8dwt_decode_step2(opj_v8_t *, opj_v8_t *, OPJ_UINT32, OPJ_UINT32, OPJ_UINT32, OPJ_FLOAT32)\x00")).as_ptr());
        }
        c += c;
        *fw.offset(-(8 as libc::c_int) as isize) =
            *fw.offset(-(8 as libc::c_int) as isize) +
                *fl.offset(0 as libc::c_int as isize) * c;
        *fw.offset(-(7 as libc::c_int) as isize) =
            *fw.offset(-(7 as libc::c_int) as isize) +
                *fl.offset(1 as libc::c_int as isize) * c;
        *fw.offset(-(6 as libc::c_int) as isize) =
            *fw.offset(-(6 as libc::c_int) as isize) +
                *fl.offset(2 as libc::c_int as isize) * c;
        *fw.offset(-(5 as libc::c_int) as isize) =
            *fw.offset(-(5 as libc::c_int) as isize) +
                *fl.offset(3 as libc::c_int as isize) * c;
        *fw.offset(-(4 as libc::c_int) as isize) =
            *fw.offset(-(4 as libc::c_int) as isize) +
                *fl.offset(4 as libc::c_int as isize) * c;
        *fw.offset(-(3 as libc::c_int) as isize) =
            *fw.offset(-(3 as libc::c_int) as isize) +
                *fl.offset(5 as libc::c_int as isize) * c;
        *fw.offset(-(2 as libc::c_int) as isize) =
            *fw.offset(-(2 as libc::c_int) as isize) +
                *fl.offset(6 as libc::c_int as isize) * c;
        *fw.offset(-(1 as libc::c_int) as isize) =
            *fw.offset(-(1 as libc::c_int) as isize) +
                *fl.offset(7 as libc::c_int as isize) * c
    };
}
/* <summary>                             */
...
unsafe extern "C" fn opj_v8dwt_decode(mut dwt: *mut opj_v8dwt_t) {
    ...
    opj_v8dwt_decode_step1((*dwt).wavelet.offset(a as isize), (*dwt).win_l_x0,
                           (*dwt).win_l_x1, opj_K);
    opj_v8dwt_decode_step1((*dwt).wavelet.offset(b as isize), (*dwt).win_h_x0,
                           (*dwt).win_h_x1, two_invK);
    opj_v8dwt_decode_step2((*dwt).wavelet.offset(b as isize),
                           (*dwt).wavelet.offset(a as
                                                     isize).offset(1 as
                                                                       libc::c_int
                                                                       as
                                                                       isize),
                           (*dwt).win_l_x0, (*dwt).win_l_x1,
                           opj_int_min((*dwt).sn, (*dwt).dn - a) as
                               OPJ_UINT32, -opj_dwt_delta);
    opj_v8dwt_decode_step2((*dwt).wavelet.offset(a as isize),
                           (*dwt).wavelet.offset(b as
                                                     isize).offset(1 as
                                                                       libc::c_int
                                                                       as
                                                                       isize),
                           (*dwt).win_h_x0, (*dwt).win_h_x1,
                           opj_int_min((*dwt).dn, (*dwt).sn - b) as
                               OPJ_UINT32, -opj_dwt_gamma);
    opj_v8dwt_decode_step2((*dwt).wavelet.offset(b as isize),
                           (*dwt).wavelet.offset(a as
                                                     isize).offset(1 as
                                                                       libc::c_int
...
unsafe extern "C" fn opj_dwt97_decode_h_func(mut user_data: *mut libc::c_void,
    ...
    w = (*job).w;
    if (*job).nb_rows.wrapping_rem(8 as libc::c_int as libc::c_uint) ==
           0 as libc::c_int as libc::c_uint {
    } else {
        __assert_fail(b"(job->nb_rows % NB_ELTS_V8) == 0\x00" as *const u8 as
                          *const libc::c_char,
                      b"/opt/openjpeg/src/lib/openjp2/dwt.c\x00" as *const u8
                          as *const libc::c_char,
                      3228 as libc::c_int as libc::c_uint,
                      (*::std::mem::transmute::<&[u8; 50],
                                                &[libc::c_char; 50]>(b"void opj_dwt97_decode_h_func(void *, opj_tls_t *)\x00")).as_ptr());
    }
    aj = (*job).aj;
    j = 0 as libc::c_int as OPJ_UINT32;
    while j.wrapping_add(8 as libc::c_int as libc::c_uint) <= (*job).nb_rows {
        let mut k: OPJ_UINT32 = 0;
        opj_v8dwt_interleave_h(&mut (*job).h, aj, (*job).w,
                               8 as libc::c_int as OPJ_UINT32);
        opj_v8dwt_decode(&mut (*job).h);
        /* To be adapted if NB_ELTS_V8 changes */
        k = 0 as libc::c_int as OPJ_UINT32;
        while k < (*job).rw {
            *aj.offset(k as isize) =
                (*(*job).h.wavelet.offset(k as
                                              isize)).f[0 as libc::c_int as
                                                            usize];
            *aj.offset((k as libc::c_ulong).wrapping_add(w as OPJ_SIZE_T) as
                           isize) =
                (*(*job).h.wavelet.offset(k as
                                              isize)).f[1 as libc::c_int as
                                                            usize];
            *aj.offset((k as
                            libc::c_ulong).wrapping_add((w as
                                                             OPJ_SIZE_T).wrapping_mul(2
                                                                                          as
                                                                                          libc::c_int
                                                                                          as
                                                                                          libc::c_ulong))
                           as isize) =
                (*(*job).h.wavelet.offset(k as
                                              isize)).f[2 as libc::c_int as
                                                            usize];
            *aj.offset((k as
                            libc::c_ulong).wrapping_add((w as
                                                             OPJ_SIZE_T).wrapping_mul(3
                                                                                          as
                                                                                          libc::c_int
                                                                                          as
                                                                                          libc::c_ulong))
        ...
        while k < (*job).rw {
            *aj.offset((k as
                           ...
                           as isize) =
                (*(*job).h.wavelet.offset(k as
                                              isize)).f[4 as libc::c_int as
                                                            usize];
            *aj.offset((k as
                            libc::c_ulong).wrapping_add((w as
                                                             OPJ_SIZE_T).wrapping_mul(5
                                                                                          as
                                                                                          libc::c_int
                                                                                          as
                                                                                          libc::c_ulong))
                           as isize) =
                (*(*job).h.wavelet.offset(k as
                                              isize)).f[5 as libc::c_int as
                                                            usize];
            *aj.offset((k as
                            libc::c_ulong).wrapping_add((w as
                                                             OPJ_SIZE_T).wrapping_mul(6
                                                                                          as
                                                                                          libc::c_int
                                                                                          as
                                                                                          libc::c_ulong))
                           as isize) =
                (*(*job).h.wavelet.offset(k as
                                              isize)).f[6 as libc::c_int as
                                                            usize];
            *aj.offset((k as
                            libc::c_ulong).wrapping_add((w as
                                                             OPJ_SIZE_T).wrapping_mul(7
                                                                                          as
                                                                                          libc::c_int
                                                                                          as
                                                                                          libc::c_ulong))
                           as isize) =
                (*(*job).h.wavelet.offset(k as
                                              isize)).f[7 as libc::c_int as
                                                            usize];
            k = k.wrapping_add(1)
        }
        aj =
            aj.offset(w.wrapping_mul(8 as libc::c_int as libc::c_uint) as
                          isize);
        j =
            (j as libc::c_uint).wrapping_add(8 as libc::c_int as libc::c_uint)
                as OPJ_UINT32 as OPJ_UINT32
...
unsafe extern "C" fn opj_dwt97_decode_v_func(mut user_data: *mut libc::c_void,
    ...
    if (*job).nb_columns.wrapping_rem(8 as libc::c_int as libc::c_uint) ==
           0 as libc::c_int as libc::c_uint {
    } else {
        __assert_fail(b"(job->nb_columns % NB_ELTS_V8) == 0\x00" as *const u8
                          as *const libc::c_char,
                      b"/opt/openjpeg/src/lib/openjp2/dwt.c\x00" as *const u8
                          as *const libc::c_char,
                      3275 as libc::c_int as libc::c_uint,
                      (*::std::mem::transmute::<&[u8; 50],
                                                &[libc::c_char; 50]>(b"void opj_dwt97_decode_v_func(void *, opj_tls_t *)\x00")).as_ptr());
    }
    aj = (*job).aj;
    j = 0 as libc::c_int as OPJ_UINT32;
    while j.wrapping_add(8 as libc::c_int as libc::c_uint) <=
              (*job).nb_columns {
        let mut k: OPJ_UINT32 = 0;
        opj_v8dwt_interleave_v(&mut (*job).v, aj, (*job).w,
                               8 as libc::c_int as OPJ_UINT32);
        opj_v8dwt_decode(&mut (*job).v);
        k = 0 as libc::c_int as OPJ_UINT32;
        while k < (*job).rh {
            memcpy(&mut *aj.offset((k as
                                        libc::c_ulong).wrapping_mul((*job).w
                                                                        as
                                                                        OPJ_SIZE_T)
                                       as isize) as *mut OPJ_FLOAT32 as
                       *mut libc::c_void,
                   &mut *(*job).v.wavelet.offset(k as isize) as *mut opj_v8_t
...
/* </summary>                            */
unsafe extern "C" fn opj_dwt_decode_tile_97(mut tp: *mut opj_thread_pool_t,
                                            mut tilec:
                                                *mut opj_tcd_tilecomp_t,
                                            mut numres: OPJ_UINT32)
 -> OPJ_BOOL {
    let mut h =
        opj_v8dwt_t{wavelet: 0 as *mut opj_v8_t,
                    dn: 0,
                    sn: 0,
                    cas: 0,
                    win_l_x0: 0,
                    ...
                    win_h_x0: 0,
                    win_h_x1:
                        0,}; /* width of the resolution level computed */
    let mut v =
        opj_v8dwt_t{wavelet: 0 as *mut opj_v8_t,
                    dn: 0,
                    sn: 0,
                    ...
                    win_h_x0: 0,
                    win_h_x1:
                        0,}; /* height of the resolution level computed */
    ...
    let mut l_data_size: OPJ_SIZE_T = 0;
    let num_threads = opj_thread_pool_get_thread_count(tp);
    if numres == 1 as libc::c_int as libc::c_uint { return 1 as libc::c_int }
    l_data_size = opj_dwt_max_resolution(res, numres) as OPJ_SIZE_T;
    /* overflow check */
    if l_data_size >
           (18446744073709551615 as
                libc::c_ulong).wrapping_div(::std::mem::size_of::<opj_v8_t>()
                                                as libc::c_ulong) {
        /* FIXME event manager error callback */
        return 0 as libc::c_int
    }
    h.wavelet =
        opj_aligned_malloc(l_data_size.wrapping_mul(::std::mem::size_of::<opj_v8_t>()
                                                        as libc::c_ulong)) as
            *mut opj_v8_t;
    ...
    loop  {
        ...
        if num_threads <= 1 as libc::c_int ||
               rh < (2 as libc::c_int * 8 as libc::c_int) as libc::c_uint {
            j = 0 as libc::c_int as OPJ_UINT32;
            while j.wrapping_add((8 as libc::c_int - 1 as libc::c_int) as
                                     libc::c_uint) < rh {
                let mut k: OPJ_UINT32 = 0;
                opj_v8dwt_interleave_h(&mut h, aj, w,
                                       8 as libc::c_int as OPJ_UINT32);
                ...
                aj =
                    aj.offset(w.wrapping_mul(8 as libc::c_int as libc::c_uint)
                                  as isize);
                j =
                    (j as
                         libc::c_uint).wrapping_add(8 as libc::c_int as
            ...
            step_j =
                rh.wrapping_div(num_jobs).wrapping_div(8 as libc::c_int as
                                                           libc::c_uint).wrapping_mul(8
                                                                                          as
                                                                                          libc::c_int
                                                                                          as
            ...
            while j < num_jobs {
                let mut job = 0 as *mut opj_dwt97_decode_h_job_t;
                job =
                    opj_malloc(::std::mem::size_of::<opj_dwt97_decode_h_job_t>()
                                   as libc::c_ulong) as
                        *mut opj_dwt97_decode_h_job_t;
                if job.is_null() {
                    opj_thread_pool_wait_completion(tp, 0 as libc::c_int);
                    ...
                    if j.wrapping_add(1 as libc::c_int as libc::c_uint) ==
                        ...
                        (rh &
                             !(8 as libc::c_int - 1 as libc::c_int) as
                                 OPJ_UINT32).wrapping_sub(j.wrapping_mul(step_j))
                    } else { step_j };
                aj = aj.offset(w.wrapping_mul((*job).nb_rows) as isize);
                opj_thread_pool_submit_job(tp,
                                           Some(opj_dwt97_decode_h_func as
                                                    unsafe extern "C" fn(_:
                                                                             *mut libc::c_void,
                                                                         _:
                                                                             *mut opj_tls_t)
        ...
        if num_threads <= 1 as libc::c_int ||
            ...
            while j > (8 as libc::c_int - 1 as libc::c_int) as libc::c_uint {
                ...
                opj_v8dwt_interleave_v(&mut v, aj, w,
                                       8 as libc::c_int as OPJ_UINT32);
                opj_v8dwt_decode(&mut v);
                k_1 = 0 as libc::c_int as OPJ_UINT32;
                while k_1 < rh {
                    memcpy(&mut *aj.offset((k_1 as
                                                libc::c_ulong).wrapping_mul(w
                                                                                as
                                                                                OPJ_SIZE_T)
                                               as isize) as *mut OPJ_FLOAT32
                               as *mut libc::c_void,
                           &mut *v.wavelet.offset(k_1 as isize) as
                               *mut opj_v8_t as *const libc::c_void,
                           (8 as libc::c_int as
                                libc::c_ulong).wrapping_mul(::std::mem::size_of::<OPJ_FLOAT32>()
                                                                as
                                                                libc::c_ulong));
             ...
             */
            let mut num_jobs_0 =
                opj_uint_max((num_threads as
                                  OPJ_UINT32).wrapping_div(2 as libc::c_int as
                                                               libc::c_uint),
                             2 as libc::c_uint);
            let mut step_j_0: OPJ_UINT32 = 0;
            ...
            step_j_0 =
                rw.wrapping_div(num_jobs_0).wrapping_div(8 as libc::c_int as
                                                             libc::c_uint).wrapping_mul(8
                                                                                            as
                                                                                            libc::c_int
                                                                                            as
            ...
            while j < num_jobs_0 {
                ...
                job_0 =
                    opj_malloc(::std::mem::size_of::<opj_dwt97_decode_v_job_t>()
                                   as libc::c_ulong) as
                        *mut opj_dwt97_decode_v_job_t;
                if job_0.is_null() {
                    opj_thread_pool_wait_completion(tp, 0 as libc::c_int);
                    opj_aligned_free(h.wavelet as *mut libc::c_void);
                    return 0 as libc::c_int
                ...
                (*job_0).nb_columns =
                    if j.wrapping_add(1 as libc::c_int as libc::c_uint) ==
                        ...
                        (rw &
                             !(8 as libc::c_int - 1 as libc::c_int) as
                                 OPJ_UINT32).wrapping_sub(j.wrapping_mul(step_j_0))
                    } else { step_j_0 };
                aj = aj.offset((*job_0).nb_columns as isize);
                opj_thread_pool_submit_job(tp,
                                           Some(opj_dwt97_decode_v_func as
                                                    unsafe extern "C" fn(_:
                                                                             *mut libc::c_void,
                                                                         _:
                                                                             *mut opj_tls_t)
        ...
        if rw & (8 as libc::c_int - 1 as libc::c_int) as libc::c_uint != 0 {
            ...
            while k_2 < rh {
                memcpy(&mut *aj.offset((k_2 as
                                            libc::c_ulong).wrapping_mul(w as
                                                                            OPJ_SIZE_T)
                                           as isize) as *mut OPJ_FLOAT32 as
                           *mut libc::c_void,
                       &mut *v.wavelet.offset(k_2 as isize) as *mut opj_v8_t
                           as *const libc::c_void,
                       (j as
                            OPJ_SIZE_T).wrapping_mul(::std::mem::size_of::<OPJ_FLOAT32>()
                                                         as libc::c_ulong));
...
unsafe extern "C" fn opj_dwt_decode_partial_97(mut tilec:
                                                   *mut opj_tcd_tilecomp_t,
                                               mut numres: OPJ_UINT32)
 -> OPJ_BOOL {
    let mut sa = 0 as *mut opj_sparse_array_int32_t;
    ...
    /* we currently use 3. */
    let filter_width =
        4 as libc::c_uint; /* width of the resolution level computed */
    let mut tr =
        (*tilec).resolutions; /* height of the resolution level computed */
    let mut tr_max: *mut opj_tcd_resolution_t =
        &mut *(*tilec).resolutions.offset(numres.wrapping_sub(1 as libc::c_int
    ...
    if numres == 1 as libc::c_uint {
        ...
        if ret != 0 {
            ...
            __assert_fail(b"ret\x00" as *const u8 as *const libc::c_char,
                          b"/opt/openjpeg/src/lib/openjp2/dwt.c\x00" as
                              *const u8 as *const libc::c_char,
                          3570 as libc::c_int as libc::c_uint,
                          (*::std::mem::transmute::<&[u8; 77],
                                                    &[libc::c_char; 77]>(b"OPJ_BOOL opj_dwt_decode_partial_97(opj_tcd_tilecomp_t *restrict, OPJ_UINT32)\x00")).as_ptr());
        }
        opj_sparse_array_int32_free(sa);
        return 1 as libc::c_int
    }
    ...
    while resno < numres {
        ...
        while j.wrapping_add((8 as libc::c_int - 1 as libc::c_int) as
                                 libc::c_uint) < rh {
            if j.wrapping_add((8 as libc::c_int - 1 as libc::c_int) as
                                  libc::c_uint) >= win_ll_y0 && j < win_ll_y1
                   ||
                   j.wrapping_add((8 as libc::c_int - 1 as libc::c_int) as
                                      libc::c_uint) >=
                       win_lh_y0.wrapping_add(v.sn as OPJ_UINT32) &&
                       j < win_lh_y1.wrapping_add(v.sn as OPJ_UINT32) {
                opj_v8dwt_interleave_partial_h(&mut h, sa, j,
                                               opj_uint_min(8 as libc::c_int
                                                                as OPJ_UINT32,
                                                            rh.wrapping_sub(j)));
                opj_v8dwt_decode(&mut h);
                if opj_sparse_array_int32_write(sa, win_tr_x0, j, win_tr_x1,
                                                j.wrapping_add(8 as
                                                                   ...
                                                                   as
                                                                   libc::c_uint),
                                                &mut *(*h.wavelet.offset(win_tr_x0
                                                                             as
                                                                             isize)).f.as_mut_ptr().offset(0
                                                                                                               as
                                                                                                               libc::c_int
                                                                                                               as
                                                                                                               isize)
                                                    as *mut OPJ_FLOAT32 as
                                                    *mut OPJ_INT32,
                                                8 as libc::c_int as
                                                    OPJ_UINT32,
                                                1 as libc::c_int as
        ...
        if j < rh &&
            ...
            opj_v8dwt_decode(&mut h);
            if opj_sparse_array_int32_write(sa, win_tr_x0, j, win_tr_x1, rh,
                                            &mut *(*h.wavelet.offset(win_tr_x0
                                                                         as
                                                                         isize)).f.as_mut_ptr().offset(0
                                                                                                           as
        ...
        while j < win_tr_x1 {
            let mut nb_elts =
                opj_uint_min(8 as libc::c_int as OPJ_UINT32,
                             win_tr_x1.wrapping_sub(j));
            opj_v8dwt_interleave_partial_v(&mut v, sa, j, nb_elts);
            opj_v8dwt_decode(&mut v);
            if opj_sparse_array_int32_write(sa, j, win_tr_y0,
                                            j.wrapping_add(nb_elts),
                                            win_tr_y1,
                                            &mut *(*h.wavelet.offset(win_tr_y0
                                                                         as
                                                                         isize)).f.as_mut_ptr().offset(0
                                                                                                           as
                                                                                                           libc::c_int
    ...
    if ret_0 != 0 {
        ...
        __assert_fail(b"ret\x00" as *const u8 as *const libc::c_char,
                      b"/opt/openjpeg/src/lib/openjp2/dwt.c\x00" as *const u8
                          as *const libc::c_char,
                      3747 as libc::c_int as libc::c_uint,
                      (*::std::mem::transmute::<&[u8; 77],
                                                &[libc::c_char; 77]>(b"OPJ_BOOL opj_dwt_decode_partial_97(opj_tcd_tilecomp_t *restrict, OPJ_UINT32)\x00")).as_ptr());
    }
    opj_sparse_array_int32_free(sa);
...
#[no_mangle]
pub unsafe extern "C" fn opj_dwt_decode_real(mut p_tcd: *mut opj_tcd_t,
                                             mut tilec:
                                                 *mut opj_tcd_tilecomp_t,
                                             mut numres: OPJ_UINT32)
 -> OPJ_BOOL {
    ...
    } else { return opj_dwt_decode_partial_97(tilec, numres) };
}
